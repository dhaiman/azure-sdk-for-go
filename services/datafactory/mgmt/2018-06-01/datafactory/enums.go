...
const (
	// TypeCredential ...
	TypeCredential TypeBasicCredential = "Credential"
	// TypeServicePrincipal ...
	TypeServicePrincipal TypeBasicCredential = "ServicePrincipal"
)
...
func PossibleTypeBasicCredentialValues() []TypeBasicCredential {
	return []TypeBasicCredential{TypeCredential, TypeServicePrincipal}
}
