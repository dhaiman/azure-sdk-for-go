...
func (client CredentialOperationsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, factoryName string, credentialName string, credential CredentialResource, ifMatch string) (result CredentialResource, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: credentialName,
			Constraints: []validation.Constraint{{Target: "credentialName", Name: validation.MaxLength, Rule: 127, Chain: nil},
				...
				{Target: "credentialName", Name: validation.Pattern, Rule: `^[A-Za-z0-9_][^<>*#.%&:\\+?/]*$`, Chain: nil}}},
...
func (client CredentialOperationsClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, factoryName string, credentialName string, credential CredentialResource, ifMatch string) (*http.Request, error) {
...
func (client CredentialOperationsClient) CreateOrUpdateResponder(resp *http.Response) (result CredentialResource, err error) {
...
func (client CredentialOperationsClient) Delete(ctx context.Context, resourceGroupName string, factoryName string, credentialName string) (result autorest.Response, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: credentialName,
			Constraints: []validation.Constraint{{Target: "credentialName", Name: validation.MaxLength, Rule: 127, Chain: nil},
				{Target: "credentialName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "credentialName", Name: validation.Pattern, Rule: `^[A-Za-z0-9_][^<>*#.%&:\\+?/]*$`, Chain: nil}}}}); err != nil {
...
func (client CredentialOperationsClient) Get(ctx context.Context, resourceGroupName string, factoryName string, credentialName string, ifNoneMatch string) (result CredentialResource, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client CredentialOperationsClient) GetResponder(resp *http.Response) (result CredentialResource, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
