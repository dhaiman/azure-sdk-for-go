...
func NewAppRoleAssignmentListResultPage(getNextPage func(context.Context, AppRoleAssignmentListResult) (AppRoleAssignmentListResult, error)) AppRoleAssignmentListResultPage {
	return AppRoleAssignmentListResultPage{fn: getNextPage}
}
