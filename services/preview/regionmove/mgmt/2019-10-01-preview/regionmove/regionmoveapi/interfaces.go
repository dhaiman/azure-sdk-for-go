...
// MoveCollectionClientAPI contains the set of methods on the MoveCollectionClient type.
type MoveCollectionClientAPI interface {
...
var _ MoveCollectionClientAPI = (*regionmove.MoveCollectionClient)(nil)
