...
// BatchUpdate updates configurations of a server group
// Parameters:
// resourceGroupName - the name of the resource group. The name is case insensitive.
// serverGroupName - the name of the server group.
// parameters - the required parameters for updating a server group configurations.
func (client ConfigurationsClient) BatchUpdate(ctx context.Context, resourceGroupName string, serverGroupName string, parameters ServerGroupConfiguration) (result ConfigurationsBatchUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.ServerGroupConfigurationProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.ServerGroupConfigurationProperties.ServerRoleGroupConfigurations", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "parameters.ServerGroupConfigurationProperties.ServerRoleGroupConfigurations", Name: validation.UniqueItems, Rule: true, Chain: nil}}},
				}}}}}); err != nil {
		return result, validation.NewError("postgresqlhsc.ConfigurationsClient", "BatchUpdate", err.Error())
	}

	req, err := client.BatchUpdatePreparer(ctx, resourceGroupName, serverGroupName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "postgresqlhsc.ConfigurationsClient", "BatchUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.BatchUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "postgresqlhsc.ConfigurationsClient", "BatchUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client ConfigurationsClient) BatchUpdatePreparer(ctx context.Context, resourceGroupName string, serverGroupName string, parameters ServerGroupConfiguration) (*http.Request, error) {
...
func (client ConfigurationsClient) BatchUpdateResponder(resp *http.Response) (result ServerGroupConfiguration, err error) {
...
func (client ConfigurationsClient) ListByServer(ctx context.Context, resourceGroupName string, serverGroupName string, serverName string) (result ConfigurationListPage, err error) {
	if tracing.IsEnabled() {
	...
	result.cl, err = client.ListByServerResponder(resp)
	if err != nil {
...
// closes the http.Response Body.
func (client ConfigurationsClient) ListByServerResponder(resp *http.Response) (result ConfigurationList, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
func (client ConfigurationsClient) listByServerNextResults(ctx context.Context, lastResults ConfigurationList) (result ConfigurationList, err error) {
	req, err := lastResults.configurationListPreparer(ctx)
	if err != nil {
...
func (client ConfigurationsClient) ListByServerComplete(ctx context.Context, resourceGroupName string, serverGroupName string, serverName string) (result ConfigurationListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ConfigurationsClient.ListByServer")
		defer func() {
			sc := -1
...
// resourceGroupName - the name of the resource group. The name is case insensitive.
// serverGroupName - the name of the server group.
func (client ConfigurationsClient) ListByServerGroup(ctx context.Context, resourceGroupName string, serverGroupName string) (result ServerGroupConfiguration, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client ConfigurationsClient) ListByServerGroupResponder(resp *http.Response) (result ServerGroupConfiguration, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
// Update updates single configuration of servers in a server group
// Parameters:
// resourceGroupName - the name of the resource group. The name is case insensitive.
// serverGroupName - the name of the server group.
// configurationName - the name of the server group configuration.
...
func (client ConfigurationsClient) Update(ctx context.Context, resourceGroupName string, serverGroupName string, configurationName string, parameters ServerGroupConfiguration) (result ConfigurationsUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: configurationName,
			Constraints: []validation.Constraint{{Target: "configurationName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "configurationName", Name: validation.MinLength, Rule: 1, Chain: nil}}},
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.ServerGroupConfigurationProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.ServerGroupConfigurationProperties.ServerRoleGroupConfigurations", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "parameters.ServerGroupConfigurationProperties.ServerRoleGroupConfigurations", Name: validation.UniqueItems, Rule: true, Chain: nil}}},
