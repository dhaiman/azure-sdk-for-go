...
// GetServer gets information about a server in server group.
// Parameters:
// resourceGroupName - the name of the resource group. The name is case insensitive.
// serverGroupName - the name of the server group.
// serverName - the name of the server.
func (client ServerGroupsClient) GetServer(ctx context.Context, resourceGroupName string, serverGroupName string, serverName string) (result ServerGroupServer, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ServerGroupsClient.GetServer")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("postgresqlhsc.ServerGroupsClient", "GetServer", err.Error())
	}

	req, err := client.GetServerPreparer(ctx, resourceGroupName, serverGroupName, serverName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "postgresqlhsc.ServerGroupsClient", "GetServer", nil, "Failure preparing request")
		return
	}

	resp, err := client.GetServerSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "postgresqlhsc.ServerGroupsClient", "GetServer", resp, "Failure sending request")
		return
	}

	result, err = client.GetServerResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "postgresqlhsc.ServerGroupsClient", "GetServer", resp, "Failure responding to request")
	}

	return
}

// GetServerPreparer prepares the GetServer request.
func (client ServerGroupsClient) GetServerPreparer(ctx context.Context, resourceGroupName string, serverGroupName string, serverName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serverGroupName":   autorest.Encode("path", serverGroupName),
...
// GetServerSender sends the GetServer request. The method will close the
// http.Response Body if it receives an error.
func (client ServerGroupsClient) GetServerSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// GetServerResponder handles the response to the GetServer request. The method always
// closes the http.Response Body.
func (client ServerGroupsClient) GetServerResponder(resp *http.Response) (result ServerGroupServer, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
// ListServers lists servers of a server group.
// Parameters:
// resourceGroupName - the name of the resource group. The name is case insensitive.
// serverGroupName - the name of the server group.
func (client ServerGroupsClient) ListServers(ctx context.Context, resourceGroupName string, serverGroupName string) (result ServerGroupServerList, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ServerGroupsClient.ListServers")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: serverGroupName,
			Constraints: []validation.Constraint{{Target: "serverGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "serverGroupName", Name: validation.MinLength, Rule: 1, Chain: nil}}}}); err != nil {
		return result, validation.NewError("postgresqlhsc.ServerGroupsClient", "ListServers", err.Error())
	}

	req, err := client.ListServersPreparer(ctx, resourceGroupName, serverGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "postgresqlhsc.ServerGroupsClient", "ListServers", nil, "Failure preparing request")
		return
	}

	resp, err := client.ListServersSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "postgresqlhsc.ServerGroupsClient", "ListServers", resp, "Failure sending request")
		return
	}

	result, err = client.ListServersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "postgresqlhsc.ServerGroupsClient", "ListServers", resp, "Failure responding to request")
	}

	return
}

// ListServersPreparer prepares the ListServers request.
func (client ServerGroupsClient) ListServersPreparer(ctx context.Context, resourceGroupName string, serverGroupName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serverGroupName":   autorest.Encode("path", serverGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// ListServersSender sends the ListServers request. The method will close the
// http.Response Body if it receives an error.
func (client ServerGroupsClient) ListServersSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// ListServersResponder handles the response to the ListServers request. The method always
// closes the http.Response Body.
func (client ServerGroupsClient) ListServersResponder(resp *http.Response) (result ServerGroupServerList, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
func (client ServerGroupsClient) Update(ctx context.Context, resourceGroupName string, serverGroupName string, parameters ServerGroupForPatch) (result ServerGroupsUpdateFuture, err error) {
	if tracing.IsEnabled() {
...
func (client ServerGroupsClient) UpdatePreparer(ctx context.Context, resourceGroupName string, serverGroupName string, parameters ServerGroupForPatch) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serverGroupName":   autorest.Encode("path", serverGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
