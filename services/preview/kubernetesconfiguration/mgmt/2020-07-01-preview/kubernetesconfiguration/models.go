...
func (ei *ExtensionInstance) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "identity":
			if v != nil {
				var identity ConfigurationIdentity
				err = json.Unmarshal(*v, &identity)
				if err != nil {
					return err
				}
				ei.Identity = &identity
			}
		case "id":
			if v != nil {
				var ID string
...
// ExtensionInstanceForCreate object to create a new Extension Instance.
type ExtensionInstanceForCreate struct {
	// ExtensionInstanceForCreateProperties - Properties of an Extension Instance resource
	*ExtensionInstanceForCreateProperties `json:"properties,omitempty"`
	// Identity - The identity of the configuration.
	Identity *ConfigurationIdentity `json:"identity,omitempty"`
	// ID - READ-ONLY; Resource Id
	ID *string `json:"id,omitempty"`
...
// MarshalJSON is the custom marshaler for ExtensionInstanceForCreate.
func (eifc ExtensionInstanceForCreate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if eifc.ExtensionInstanceForCreateProperties != nil {
		objectMap["properties"] = eifc.ExtensionInstanceForCreateProperties
	}
	if eifc.Identity != nil {
		objectMap["identity"] = eifc.Identity
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for ExtensionInstanceForCreate struct.
func (eifc *ExtensionInstanceForCreate) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var extensionInstanceForCreateProperties ExtensionInstanceForCreateProperties
				err = json.Unmarshal(*v, &extensionInstanceForCreateProperties)
				if err != nil {
					return err
				}
				eifc.ExtensionInstanceForCreateProperties = &extensionInstanceForCreateProperties
			}
		case "identity":
			if v != nil {
				var identity ConfigurationIdentity
...
// ExtensionInstanceForCreateProperties properties of an Extension Instance resource
type ExtensionInstanceForCreateProperties struct {
...
// MarshalJSON is the custom marshaler for ExtensionInstanceForCreateProperties.
func (eifc ExtensionInstanceForCreateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if eifc.ExtensionType != nil {
		objectMap["extensionType"] = eifc.ExtensionType
	}
	if eifc.AutoUpgradeMinorVersion != nil {
		objectMap["autoUpgradeMinorVersion"] = eifc.AutoUpgradeMinorVersion
	}
	if eifc.ReleaseTrain != nil {
		objectMap["releaseTrain"] = eifc.ReleaseTrain
	}
	if eifc.Version != nil {
		objectMap["version"] = eifc.Version
	}
	if eifc.Scope != nil {
		objectMap["scope"] = eifc.Scope
	}
	if eifc.ConfigurationSettings != nil {
		objectMap["configurationSettings"] = eifc.ConfigurationSettings
	}
	if eifc.ConfigurationProtectedSettings != nil {
		objectMap["configurationProtectedSettings"] = eifc.ConfigurationProtectedSettings
	}
	return json.Marshal(objectMap)
}

// ExtensionInstanceForList the Extension Instance object.
type ExtensionInstanceForList struct {
	// ExtensionInstanceForListProperties - READ-ONLY; Properties of an Extension Instance resource
	*ExtensionInstanceForListProperties `json:"properties,omitempty"`
	// Identity - The identity of the configuration.
	Identity *ConfigurationIdentity `json:"identity,omitempty"`
	// ID - READ-ONLY; Resource Id
	ID *string `json:"id,omitempty"`
...
// MarshalJSON is the custom marshaler for ExtensionInstanceForList.
func (eifl ExtensionInstanceForList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if eifl.Identity != nil {
		objectMap["identity"] = eifl.Identity
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for ExtensionInstanceForList struct.
func (eifl *ExtensionInstanceForList) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var extensionInstanceForListProperties ExtensionInstanceForListProperties
				err = json.Unmarshal(*v, &extensionInstanceForListProperties)
				if err != nil {
					return err
				}
				eifl.ExtensionInstanceForListProperties = &extensionInstanceForListProperties
			}
		case "identity":
			if v != nil {
				var identity ConfigurationIdentity
...
// ExtensionInstanceForListProperties properties of an Extension Instance resource
type ExtensionInstanceForListProperties struct {
	// ExtensionType - Type of the Extension, of which this resource is an instance of.  It must be one of the Extension Types registered with Microsoft.KubernetesConfiguration by the Extension publisher.
	ExtensionType *string `json:"extensionType,omitempty"`
	// AutoUpgradeMinorVersion - Flag to note if this instance participates in auto upgrade of minor version, or not.
	AutoUpgradeMinorVersion *bool `json:"autoUpgradeMinorVersion,omitempty"`
	// ReleaseTrain - ReleaseTrain this extension instance participates in for auto-upgrade (e.g. Stable, Preview, etc.) - only if autoUpgradeMinorVersion is 'true'.
	ReleaseTrain *string `json:"releaseTrain,omitempty"`
	// Version - Version of the extension for this extension instance, if it is 'pinned' to a specific version.
	Version *string `json:"version,omitempty"`
	// Scope - Scope at which the extension instance is installed.
	Scope *Scope `json:"scope,omitempty"`
...
// MarshalJSON is the custom marshaler for ExtensionInstanceForListProperties.
func (eifl ExtensionInstanceForListProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if eifl.ExtensionType != nil {
		objectMap["extensionType"] = eifl.ExtensionType
	}
	if eifl.AutoUpgradeMinorVersion != nil {
		objectMap["autoUpgradeMinorVersion"] = eifl.AutoUpgradeMinorVersion
	}
	if eifl.ReleaseTrain != nil {
		objectMap["releaseTrain"] = eifl.ReleaseTrain
	}
	if eifl.Version != nil {
		objectMap["version"] = eifl.Version
	}
	if eifl.Scope != nil {
		objectMap["scope"] = eifl.Scope
	}
	if eifl.InstallState != "" {
		objectMap["installState"] = eifl.InstallState
	}
	return json.Marshal(objectMap)
}
...
type ExtensionInstancesList struct {
	...
	Value *[]ExtensionInstanceForList `json:"value,omitempty"`
	// NextLink - READ-ONLY; URL to get the next set of extension instance objects, if any.
	NextLink *string `json:"nextLink,omitempty"`
}

// ExtensionInstancesListIterator provides access to a complete listing of ExtensionInstanceForList values.
...
func (iter ExtensionInstancesListIterator) Value() ExtensionInstanceForList {
	if !iter.page.NotDone() {
		return ExtensionInstanceForList{}
	}
...
// ExtensionInstancesListPage contains a page of ExtensionInstanceForList values.
...
func (page ExtensionInstancesListPage) Values() []ExtensionInstanceForList {
	if page.eil.IsEmpty() {
		return nil
	}
...
func NewExtensionInstancesListPage(getNextPage func(context.Context, ExtensionInstancesList) (ExtensionInstancesList, error)) ExtensionInstancesListPage {
	return ExtensionInstancesListPage{fn: getNextPage}
}
...
func (sccfc SourceControlConfigurationForCreateProperties) MarshalJSON() ([]byte, error) {
	...
	if sccfc.EnableHelmOperator != nil {
