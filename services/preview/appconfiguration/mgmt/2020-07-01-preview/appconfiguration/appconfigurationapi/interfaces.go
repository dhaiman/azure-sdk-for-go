...
// EventGridFiltersClientAPI contains the set of methods on the EventGridFiltersClient type.
type EventGridFiltersClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, configStoreName string, eventGridFilterName string) (result appconfiguration.EventGridFilter, err error)
	ListByConfigurationStore(ctx context.Context, resourceGroupName string, configStoreName string, skipToken string) (result appconfiguration.EventGridFilterListResultPage, err error)
	ListByConfigurationStoreComplete(ctx context.Context, resourceGroupName string, configStoreName string, skipToken string) (result appconfiguration.EventGridFilterListResultIterator, err error)
}

var _ EventGridFiltersClientAPI = (*appconfiguration.EventGridFiltersClient)(nil)
