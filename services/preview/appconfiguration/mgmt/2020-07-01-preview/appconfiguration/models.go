...
type EventFilter struct {
	// SubjectBeginsWith - READ-ONLY; The subject prefix used for filtering events
	SubjectBeginsWith *string `json:"subjectBeginsWith,omitempty"`
	// SubjectEndsWith - READ-ONLY; The subject suffix used for filtering events
	SubjectEndsWith *string `json:"subjectEndsWith,omitempty"`
	// IncludedEventTypes - The event types that will be sent to Event Grid.
	IncludedEventTypes *[]string `json:"includedEventTypes,omitempty"`
}

// MarshalJSON is the custom marshaler for EventFilter.
func (ef EventFilter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if ef.IncludedEventTypes != nil {
		objectMap["includedEventTypes"] = ef.IncludedEventTypes
	}
	return json.Marshal(objectMap)
}
...
type EventGridFilter struct {
	...
	*EventGridFilterProperties `json:"properties,omitempty"`
}

// MarshalJSON is the custom marshaler for EventGridFilter.
func (egf EventGridFilter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if egf.EventGridFilterProperties != nil {
		objectMap["properties"] = egf.EventGridFilterProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for EventGridFilter struct.
func (egf *EventGridFilter) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var eventGridFilterProperties EventGridFilterProperties
				err = json.Unmarshal(*v, &eventGridFilterProperties)
				if err != nil {
					return err
				}
				egf.EventGridFilterProperties = &eventGridFilterProperties
			}
		}
	}
...
type EventGridFilterListResult struct {
	autorest.Response `json:"-"`
	// Value - The collection value.
	Value *[]EventGridFilter `json:"value,omitempty"`
	// NextLink - The URI that can be used to request the next set of paged results.
	NextLink *string `json:"nextLink,omitempty"`
}

// EventGridFilterListResultIterator provides access to a complete listing of EventGridFilter values.
type EventGridFilterListResultIterator struct {
	i    int
	page EventGridFilterListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *EventGridFilterListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/EventGridFilterListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *EventGridFilterListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter EventGridFilterListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter EventGridFilterListResultIterator) Response() EventGridFilterListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter EventGridFilterListResultIterator) Value() EventGridFilter {
	if !iter.page.NotDone() {
		return EventGridFilter{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the EventGridFilterListResultIterator type.
func NewEventGridFilterListResultIterator(page EventGridFilterListResultPage) EventGridFilterListResultIterator {
	return EventGridFilterListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (egflr EventGridFilterListResult) IsEmpty() bool {
	return egflr.Value == nil || len(*egflr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (egflr EventGridFilterListResult) hasNextLink() bool {
	return egflr.NextLink != nil && len(*egflr.NextLink) != 0
}

// eventGridFilterListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (egflr EventGridFilterListResult) eventGridFilterListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !egflr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(egflr.NextLink)))
}

// EventGridFilterListResultPage contains a page of EventGridFilter values.
type EventGridFilterListResultPage struct {
	fn    func(context.Context, EventGridFilterListResult) (EventGridFilterListResult, error)
	egflr EventGridFilterListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *EventGridFilterListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/EventGridFilterListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.egflr)
		if err != nil {
			return err
		}
		page.egflr = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *EventGridFilterListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page EventGridFilterListResultPage) NotDone() bool {
	return !page.egflr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page EventGridFilterListResultPage) Response() EventGridFilterListResult {
	return page.egflr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page EventGridFilterListResultPage) Values() []EventGridFilter {
	if page.egflr.IsEmpty() {
		return nil
	}
	return *page.egflr.Value
}

// Creates a new instance of the EventGridFilterListResultPage type.
func NewEventGridFilterListResultPage(cur EventGridFilterListResult, getNextPage func(context.Context, EventGridFilterListResult) (EventGridFilterListResult, error)) EventGridFilterListResultPage {
	return EventGridFilterListResultPage{
		fn:    getNextPage,
		egflr: cur,
	}
}
...
type EventGridFilterProperties struct {
	// ProvisioningState - READ-ONLY; The provisioning state of the event grid filter. Possible values include: 'Creating', 'Updating', 'Deleting', 'Succeeded', 'Failed', 'Canceled'
	ProvisioningState ProvisioningState `json:"provisioningState,omitempty"`
	// Filter - READ-ONLY; Properties describing the filtering behavior of the event grid filter.
	Filter *EventFilter `json:"filter,omitempty"`
	// SubscriberIdentityInfo - READ-ONLY; Information describing the event subscriber.
	SubscriberIdentityInfo *SubscriberIdentityInfo `json:"subscriberIdentityInfo,omitempty"`
}
...
type SubscriberIdentityInfo struct {
	// ClientPrincipalID - READ-ONLY; The principal id of the subscriber.
	ClientPrincipalID *string `json:"clientPrincipalId,omitempty"`
	// ClientObjectID - READ-ONLY; The object id of the subscriber.
	ClientObjectID *string `json:"clientObjectId,omitempty"`
	// ClientTenantID - READ-ONLY; The client id of the subscriber.
	ClientTenantID *string `json:"clientTenantId,omitempty"`
	// ClientApplicationID - READ-ONLY; The application id of the subscriber.
	ClientApplicationID *string `json:"clientApplicationId,omitempty"`
	// ClientAuthorizationSource - READ-ONLY; The authorization source of the subscriber.
	ClientAuthorizationSource *string `json:"clientAuthorizationSource,omitempty"`
}
