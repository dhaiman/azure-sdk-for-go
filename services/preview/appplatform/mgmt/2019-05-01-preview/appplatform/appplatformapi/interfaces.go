...
type CertificatesClientAPI interface {
	...
	List(ctx context.Context, resourceGroupName string, serviceName string) (result appplatform.CertificateResourceCollection, err error)
}
...
type CustomDomainsClientAPI interface {
	CheckNameAvailability(ctx context.Context, availabilityParameters appplatform.NameAvailabilityParameters, resourceGroupName string, serviceName string, appName string) (result appplatform.NameAvailability, err error)
	...
	List(ctx context.Context, resourceGroupName string, serviceName string, appName string) (result appplatform.CustomDomainResourceCollection, err error)
	Update(ctx context.Context, domainResource appplatform.CustomDomainResource, resourceGroupName string, serviceName string, appName string, domainName string) (result appplatform.CustomDomainResource, err error)
}
