...
// appName - the name of the App resource.
// domainName - the name of the custom domain resource.
func (client CustomDomainsClient) List(ctx context.Context, resourceGroupName string, serviceName string, appName string, domainName string) (result CustomDomainResourceCollectionPage, err error) {
	if tracing.IsEnabled() {
...
func (client CustomDomainsClient) ListComplete(ctx context.Context, resourceGroupName string, serviceName string, appName string, domainName string) (result CustomDomainResourceCollectionIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/CustomDomainsClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, resourceGroupName, serviceName, appName, domainName)
	return
}
