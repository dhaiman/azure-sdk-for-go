...
func (client CustomDomainsClient) CheckNameAvailability(ctx context.Context, availabilityParameters NameAvailabilityParameters, resourceGroupName string, serviceName string, appName string) (result NameAvailability, err error) {
	...
	req, err := client.CheckNameAvailabilityPreparer(ctx, availabilityParameters, resourceGroupName, serviceName, appName)
	if err != nil {
...
func (client CustomDomainsClient) CheckNameAvailabilityPreparer(ctx context.Context, availabilityParameters NameAvailabilityParameters, resourceGroupName string, serviceName string, appName string) (*http.Request, error) {
...
// serviceName - the name of the Service resource.
// appName - the name of the App resource.
func (client CustomDomainsClient) List(ctx context.Context, resourceGroupName string, serviceName string, appName string) (result CustomDomainResourceCollection, err error) {
	if tracing.IsEnabled() {
...
// appName - the name of the App resource.
// domainName - the name of the custom domain resource.
func (client CustomDomainsClient) Update(ctx context.Context, domainResource CustomDomainResource, resourceGroupName string, serviceName string, appName string, domainName string) (result CustomDomainResource, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.UpdatePreparer(ctx, domainResource, resourceGroupName, serviceName, appName, domainName)
	if err != nil {
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "appplatform.CustomDomainsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.CustomDomainsClient", "Update", resp, "Failure responding to request")
	}
...
func (client CustomDomainsClient) UpdatePreparer(ctx context.Context, domainResource CustomDomainResource, resourceGroupName string, serviceName string, appName string, domainName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"appName":           autorest.Encode("path", appName),
		"domainName":        autorest.Encode("path", domainName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
