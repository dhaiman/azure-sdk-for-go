...
func (client SkuClient) List(ctx context.Context) (result ResourceTypeSkuCollection, err error) {
...
func (client SkuClient) ListResponder(resp *http.Response) (result ResourceTypeSkuCollection, err error) {
