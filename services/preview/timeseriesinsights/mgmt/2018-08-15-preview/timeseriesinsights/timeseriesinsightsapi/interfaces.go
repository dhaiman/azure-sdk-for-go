...
type EnvironmentsClientAPI interface {
	...
	Update(ctx context.Context, resourceGroupName string, environmentName string, longTermEnvironmentUpdateParameters timeseriesinsights.LongTermEnvironmentUpdateParameters) (result timeseriesinsights.EnvironmentsUpdateFuture, err error)
}
