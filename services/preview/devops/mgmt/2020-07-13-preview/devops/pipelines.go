...
func (client PipelinesClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, pipelineName string, createOperationParameters Pipeline) (result PipelinesCreateOrUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: createOperationParameters,
			Constraints: []validation.Constraint{{Target: "createOperationParameters.BasicPipelineProperties", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "createOperationParameters.BasicPipelineProperties.BootstrapConfiguration", Name: validation.Null, Rule: true,
					Chain: []validation.Constraint{{Target: "createOperationParameters.BasicPipelineProperties.BootstrapConfiguration.SourceRepository", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "createOperationParameters.BasicPipelineProperties.BootstrapConfiguration.SourceRepository.ID", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "createOperationParameters.BasicPipelineProperties.BootstrapConfiguration.SourceRepository.DefaultBranch", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "createOperationParameters.BasicPipelineProperties.BootstrapConfiguration.SourceRepository.Authorization", Name: validation.Null, Rule: false,
								Chain: []validation.Constraint{{Target: "createOperationParameters.BasicPipelineProperties.BootstrapConfiguration.SourceRepository.Authorization.AuthorizationType", Name: validation.Null, Rule: true, Chain: nil}}},
						}},
						{Target: "createOperationParameters.BasicPipelineProperties.BootstrapConfiguration.Template", Name: validation.Null, Rule: true,
							Chain: []validation.Constraint{{Target: "createOperationParameters.BasicPipelineProperties.BootstrapConfiguration.Template.ID", Name: validation.Null, Rule: true, Chain: nil}}},
					}},
				}}}}}); err != nil {
