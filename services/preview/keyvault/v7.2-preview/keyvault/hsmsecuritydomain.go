...
// certificates - security domain download operation requires customer to provide three public keys of RSA
// certificates in PEM format.
func (client HSMSecurityDomainClient) Download(ctx context.Context, vaultBaseURL string, certificates CertificateSet) (result DownloadOKResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: certificates,
			Constraints: []validation.Constraint{{Target: "certificates.Certificates", Name: validation.Null, Rule: false,
...
func (client HSMSecurityDomainClient) DownloadResponder(resp *http.Response) (result DownloadOKResponse, err error) {
...
func (client HSMSecurityDomainClient) TransferKeyMethodPreparer(ctx context.Context, vaultBaseURL string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithCustomBaseURL("{vaultBaseUrl}", urlParameters),
		autorest.WithPath("/securitydomain/transfer_key"))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// Parameters:
// vaultBaseURL - the vault name, for example https://myvault.vault.azure.net.
func (client HSMSecurityDomainClient) Upload(ctx context.Context, vaultBaseURL string, securityDomain SecurityDomain) (result UploadAcceptedResponse, err error) {
	if tracing.IsEnabled() {
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "keyvault.HSMSecurityDomainClient", "Upload", resp, "Failure sending request")
		return
	}

	result, err = client.UploadResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "keyvault.HSMSecurityDomainClient", "Upload", resp, "Failure responding to request")
	}
...
func (client HSMSecurityDomainClient) UploadPreparer(ctx context.Context, vaultBaseURL string, securityDomain SecurityDomain) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"vaultBaseUrl": vaultBaseURL,
	}
...
// http.Response Body if it receives an error.
func (client HSMSecurityDomainClient) UploadSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
}

// UploadResponder handles the response to the Upload request. The method always
// closes the http.Response Body.
func (client HSMSecurityDomainClient) UploadResponder(resp *http.Response) (result UploadAcceptedResponse, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
...
// Parameters:
// vaultBaseURL - the vault name, for example https://myvault.vault.azure.net.
func (client HSMSecurityDomainClient) UploadPending(ctx context.Context, vaultBaseURL string) (result UploadPendingOKResponse, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client HSMSecurityDomainClient) UploadPendingResponder(resp *http.Response) (result UploadPendingOKResponse, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
