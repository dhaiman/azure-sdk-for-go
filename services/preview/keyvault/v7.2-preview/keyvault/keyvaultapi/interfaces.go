...
type BaseClientAPI interface {
	...
	SelectiveKeyRestoreOperationMethod(ctx context.Context, vaultBaseURL string, keyName string, restoreBlobDetails *keyvault.SelectiveKeyRestoreOperationParameters) (result keyvault.SelectiveKeyRestoreOperation, err error)
...
type HSMSecurityDomainClientAPI interface {
	Download(ctx context.Context, vaultBaseURL string, certificates keyvault.CertificateSet) (result keyvault.DownloadOKResponse, err error)
	TransferKeyMethod(ctx context.Context, vaultBaseURL string) (result keyvault.TransferKey, err error)
	Upload(ctx context.Context, vaultBaseURL string, securityDomain keyvault.SecurityDomain) (result keyvault.UploadAcceptedResponse, err error)
	UploadPending(ctx context.Context, vaultBaseURL string) (result keyvault.UploadPendingOKResponse, err error)
}
