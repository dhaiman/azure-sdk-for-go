...
// DownloadOKResponse ...
type DownloadOKResponse struct {
	autorest.Response `json:"-"`
	Value             *string `json:"value,omitempty"`
}
...
type SecurityDomainCertificateItem struct {
	// Value - Public key of customer generated RSA certificate in PEM format (a URL-encoded base64 string)
	Value *string `json:"value,omitempty"`
}
...
type TransferKey struct {
	autorest.Response `json:"-"`
	TransferKey       *JSONWebKey `json:"transfer_key,omitempty"`
}
...
// UploadPendingOKResponse ...
type UploadPendingOKResponse struct {
	autorest.Response `json:"-"`
	Status            *string `json:"status,omitempty"`
	StatusDetails     *string `json:"status_details,omitempty"`
}
