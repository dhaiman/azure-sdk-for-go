...
// SqlxClientAPI contains the set of methods on the SqlxClient type.
type SqlxClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, accountName string, createUpdateServiceResourceParameters documentdb.ServiceResourceCreateUpdateParameters) (result documentdb.SqlxCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, accountName string) (result documentdb.SqlxDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, accountName string) (result documentdb.ServiceGetResults, err error)
}

var _ SqlxClientAPI = (*documentdb.SqlxClient)(nil)
