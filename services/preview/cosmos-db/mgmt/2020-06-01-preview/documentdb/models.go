...
type RestorableDatabaseAccountProperties struct {
	...
	// APIType - READ-ONLY; Enum to indicate the API type of the restorable database account. Possible values include: 'MongoDB', 'Gremlin', 'Cassandra', 'Table', 'SQL', 'Etcd', 'GremlinV2'
