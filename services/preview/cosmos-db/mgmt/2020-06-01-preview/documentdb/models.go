...
type RestorableDatabaseAccountProperties struct {
	...
	// APIType - READ-ONLY; Enum to indicate the API type of the restorable database account. Possible values include: 'None', 'MongoDB', 'Gremlin', 'Cassandra', 'Table', 'SQL', 'Etcd', 'GremlinV2'
...
type RestorableMongodbCollectionPropertiesResource struct {
	// Rid - READ-ONLY; A system generated property. A unique identifier.
	Rid *string `json:"_rid,omitempty"`
	// OperationType - READ-ONLY; The operation type of this collection event.
	...
	DocumentCollection *RestorableMongodbCollectionPropertiesResourceDocumentCollection `json:"documentCollection,omitempty"`
}
...
func (rmcp RestorableMongodbCollectionPropertiesResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rmcp.DocumentCollection != nil {
		objectMap["documentCollection"] = rmcp.DocumentCollection
	}
	return json.Marshal(objectMap)
}

// RestorableMongodbCollectionPropertiesResourceDocumentCollection ...
type RestorableMongodbCollectionPropertiesResourceDocumentCollection struct {
	// ID - Name of the Cosmos DB MongoDB collection
	ID *string `json:"id,omitempty"`
	// ShardKey - A key-value pair of shard keys to be applied for the request.
	ShardKey map[string]*string `json:"shardKey"`
	...
	// Etag - READ-ONLY; A system generated property representing the resource etag required for optimistic concurrency control.
	Etag *string `json:"_etag,omitempty"`
	// Self - A system generated property that specifies the addressable path of the collection resource.
	Self *string `json:"_self,omitempty"`
}

// MarshalJSON is the custom marshaler for RestorableMongodbCollectionPropertiesResourceDocumentCollection.
func (rmcpC RestorableMongodbCollectionPropertiesResourceDocumentCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rmcpC.ID != nil {
		objectMap["id"] = rmcpC.ID
	}
	if rmcpC.ShardKey != nil {
		objectMap["shardKey"] = rmcpC.ShardKey
	}
	if rmcpC.Indexes != nil {
		objectMap["indexes"] = rmcpC.Indexes
	}
	if rmcpC.AnalyticalStorageTTL != nil {
		objectMap["analyticalStorageTtl"] = rmcpC.AnalyticalStorageTTL
	}
	if rmcpC.Self != nil {
		objectMap["_self"] = rmcpC.Self
	}
	return json.Marshal(objectMap)
}
...
type RestorableMongodbDatabasePropertiesResource struct {
	// Rid - READ-ONLY; A system generated property. A unique identifier.
	Rid *string `json:"_rid,omitempty"`
	// OperationType - READ-ONLY; The operation type of this database event.
	OperationType *string `json:"operationType,omitempty"`
	...
	OwnerResourceID *string                                              `json:"ownerResourceId,omitempty"`
	Database        *RestorableMongodbDatabasePropertiesResourceDatabase `json:"database,omitempty"`
}
...
func (rmdp RestorableMongodbDatabasePropertiesResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rmdp.Database != nil {
		objectMap["database"] = rmdp.Database
	}
	return json.Marshal(objectMap)
}

// RestorableMongodbDatabasePropertiesResourceDatabase ...
type RestorableMongodbDatabasePropertiesResourceDatabase struct {
	// ID - Name of the Cosmos DB MongoDB database
	ID *string `json:"id,omitempty"`
	// Rid - READ-ONLY; A system generated property. A unique identifier.
	Rid *string `json:"_rid,omitempty"`
...
// MarshalJSON is the custom marshaler for RestorableMongodbDatabasePropertiesResourceDatabase.
func (rmdp RestorableMongodbDatabasePropertiesResourceDatabase) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rmdp.ID != nil {
		objectMap["id"] = rmdp.ID
	}
	return json.Marshal(objectMap)
}
...
type RestorableSQLContainerPropertiesResource struct {
	// Rid - READ-ONLY; A system generated property. A unique identifier.
	Rid *string `json:"_rid,omitempty"`
	// OperationType - READ-ONLY; The operation type of this container event.
	OperationType *string `json:"operationType,omitempty"`
	...
	OwnerResourceID    *string                                                     `json:"ownerResourceId,omitempty"`
	DocumentCollection *RestorableSQLContainerPropertiesResourceDocumentCollection `json:"documentCollection,omitempty"`
}
...
func (rscp RestorableSQLContainerPropertiesResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rscp.DocumentCollection != nil {
		objectMap["documentCollection"] = rscp.DocumentCollection
	}
	return json.Marshal(objectMap)
}

// RestorableSQLContainerPropertiesResourceDocumentCollection ...
type RestorableSQLContainerPropertiesResourceDocumentCollection struct {
...
// MarshalJSON is the custom marshaler for RestorableSQLContainerPropertiesResourceDocumentCollection.
func (rscpC RestorableSQLContainerPropertiesResourceDocumentCollection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rscpC.ID != nil {
		objectMap["id"] = rscpC.ID
	}
	if rscpC.IndexingPolicy != nil {
		objectMap["indexingPolicy"] = rscpC.IndexingPolicy
	}
	if rscpC.PartitionKey != nil {
		objectMap["partitionKey"] = rscpC.PartitionKey
	}
	if rscpC.DefaultTTL != nil {
		objectMap["defaultTtl"] = rscpC.DefaultTTL
	}
	if rscpC.UniqueKeyPolicy != nil {
		objectMap["uniqueKeyPolicy"] = rscpC.UniqueKeyPolicy
	}
	if rscpC.ConflictResolutionPolicy != nil {
		objectMap["conflictResolutionPolicy"] = rscpC.ConflictResolutionPolicy
	}
	return json.Marshal(objectMap)
}
