...
// restoreLocation - the location where the resources are located.
// restoreTimestampInUtc - the timestamp when the resources exist.
...
func (client RestorableSQLResourcesClient) ListPreparer(ctx context.Context, location string, instanceID string, restoreLocation string, restoreTimestampInUtc string) (*http.Request, error) {
	...
	queryParameters := map[string]interface{}{
		...
		"restoreLocation":       autorest.Encode("query", restoreLocation),
		"restoreTimestampInUtc": autorest.Encode("query", restoreTimestampInUtc),
	}
