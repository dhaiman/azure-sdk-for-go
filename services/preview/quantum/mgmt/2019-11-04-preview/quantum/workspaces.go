...
// CreateAndUpdate create or update workspace resource.
// Parameters:
// resourceGroupName - the name of the resource group.
// workspaceName - the name of quantum workspace resource.
// quantumWorkspace - quantum workspace details.
func (client WorkspacesClient) CreateAndUpdate(ctx context.Context, resourceGroupName string, workspaceName string, quantumWorkspace Workspace) (result WorkspacesCreateAndUpdateFuture, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/WorkspacesClient.CreateAndUpdate")
		defer func() {
			sc := -1
	...
	req, err := client.CreateAndUpdatePreparer(ctx, resourceGroupName, workspaceName, quantumWorkspace)
	if err != nil {
		err = autorest.NewErrorWithError(err, "quantum.WorkspacesClient", "CreateAndUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateAndUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "quantum.WorkspacesClient", "CreateAndUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client WorkspacesClient) CreateAndUpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, quantumWorkspace Workspace) (*http.Request, error) {
	...
	quantumWorkspace.ID = nil
	quantumWorkspace.Name = nil
	quantumWorkspace.Type = nil
...
func (client WorkspacesClient) CreateAndUpdateSender(req *http.Request) (future WorkspacesCreateAndUpdateFuture, err error) {
...
func (client WorkspacesClient) CreateAndUpdateResponder(resp *http.Response) (result Workspace, err error) {
...
// Get returns workspace resource for a given name.
// Parameters:
// resourceGroupName - the name of the resource group.
// workspaceName - the name of quantum workspace resource.
...
// ListByResourceGroup gets the available workspaces within a resource group.
// Parameters:
// resourceGroupName - the name of the resource group.
...
// Update updates a quantum workspace.
// Parameters:
// resourceGroupName - the name of the resource group.
// workspaceName - the name of quantum workspace resource.
// quantumWorkspace - quantum workspace details.
func (client WorkspacesClient) Update(ctx context.Context, resourceGroupName string, workspaceName string, quantumWorkspace Workspace) (result Workspace, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.UpdatePreparer(ctx, resourceGroupName, workspaceName, quantumWorkspace)
	if err != nil {
		err = autorest.NewErrorWithError(err, "quantum.WorkspacesClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "quantum.WorkspacesClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "quantum.WorkspacesClient", "Update", resp, "Failure responding to request")
	}
...
func (client WorkspacesClient) UpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, quantumWorkspace Workspace) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
		"workspaceName":     autorest.Encode("path", workspaceName),
