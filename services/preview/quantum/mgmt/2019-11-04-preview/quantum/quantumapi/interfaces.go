...
type WorkspacesClientAPI interface {
	CreateAndUpdate(ctx context.Context, resourceGroupName string, workspaceName string, quantumWorkspace quantum.Workspace) (result quantum.WorkspacesCreateAndUpdateFuture, err error)
	...
	Update(ctx context.Context, resourceGroupName string, workspaceName string, quantumWorkspace quantum.Workspace) (result quantum.Workspace, err error)
}
...
type OfferingsClientAPI interface {
	List(ctx context.Context, locationName string) (result quantum.ProviderListResultPage, err error)
	ListComplete(ctx context.Context, locationName string) (result quantum.ProviderListResultIterator, err error)
}
