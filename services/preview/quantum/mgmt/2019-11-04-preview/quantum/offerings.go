...
// List returns the list of all providers available for the given location.
// Parameters:
// locationName - location.
func (client OfferingsClient) List(ctx context.Context, locationName string) (result ProviderListResultPage, err error) {
...
func (client OfferingsClient) ListResponder(resp *http.Response) (result ProviderListResult, err error) {
...
func (client OfferingsClient) listNextResults(ctx context.Context, lastResults ProviderListResult) (result ProviderListResult, err error) {
...
func (client OfferingsClient) ListComplete(ctx context.Context, locationName string) (result ProviderListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/OfferingsClient.List")
		defer func() {
			sc := -1
