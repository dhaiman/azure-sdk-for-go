...
// MonitorInfoClientAPI contains the set of methods on the MonitorInfoClient type.
type MonitorInfoClientAPI interface {
...
var _ MonitorInfoClientAPI = (*workloadmonitor.MonitorInfoClient)(nil)

// MonitorStateChangesClientAPI contains the set of methods on the MonitorStateChangesClient type.
type MonitorStateChangesClientAPI interface {
	List(ctx context.Context, subscriptionID string, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, monitorID string, filter string, expand string, startTimestampUtc *date.Time, endTimestampUtc *date.Time) (result workloadmonitor.MonitorStateChangeListPage, err error)
	ListComplete(ctx context.Context, subscriptionID string, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, monitorID string, filter string, expand string, startTimestampUtc *date.Time, endTimestampUtc *date.Time) (result workloadmonitor.MonitorStateChangeListIterator, err error)
}

var _ MonitorStateChangesClientAPI = (*workloadmonitor.MonitorStateChangesClient)(nil)

// MonitorHistoricalStateChangeClientAPI contains the set of methods on the MonitorHistoricalStateChangeClient type.
type MonitorHistoricalStateChangeClientAPI interface {
	Get(ctx context.Context, subscriptionID string, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, monitorID string, timestampUnix string, expand string) (result workloadmonitor.MonitorStateChange, err error)
}

var _ MonitorHistoricalStateChangeClientAPI = (*workloadmonitor.MonitorHistoricalStateChangeClient)(nil)
