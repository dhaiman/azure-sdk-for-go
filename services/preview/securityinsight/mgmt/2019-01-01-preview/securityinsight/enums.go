...
const (
	...
	// EntityQueryKindBookmark bookmarks
	EntityQueryKindBookmark EntityQueryKind = "Bookmark"
	// EntityQueryKindSecurityAlert security alerts
	EntityQueryKindSecurityAlert EntityQueryKind = "SecurityAlert"
)
...
func PossibleEntityQueryKindValues() []EntityQueryKind {
	return []EntityQueryKind{EntityQueryKindActivity, EntityQueryKindBookmark, EntityQueryKindSecurityAlert}
}
...
// QueryKind enumerates the values for query kind.
type QueryKind string

const (
	// QueryKindActivity ...
	QueryKindActivity QueryKind = "Activity"
	// QueryKindBookmark ...
	QueryKindBookmark QueryKind = "Bookmark"
	// QueryKindEntityTimelineItem ...
	QueryKindEntityTimelineItem QueryKind = "EntityTimelineItem"
	// QueryKindSecurityAlert ...
	QueryKindSecurityAlert QueryKind = "SecurityAlert"
)

// PossibleQueryKindValues returns an array of possible values for the QueryKind const type.
func PossibleQueryKindValues() []QueryKind {
	return []QueryKind{QueryKindActivity, QueryKindBookmark, QueryKindEntityTimelineItem, QueryKindSecurityAlert}
}
