...
type ActivityTimelineItem struct {
	...
	// QueryKind - Possible values include: 'QueryKindEntityTimelineItem', 'QueryKindActivity', 'QueryKindSecurityAlert', 'QueryKindBookmark'
	QueryKind QueryKind `json:"queryKind,omitempty"`
}

// MarshalJSON is the custom marshaler for ActivityTimelineItem.
func (ati ActivityTimelineItem) MarshalJSON() ([]byte, error) {
	ati.QueryKind = QueryKindActivity
	objectMap := make(map[string]interface{})
	if ati.QueryID != nil {
	...
	if ati.QueryKind != "" {
		objectMap["queryKind"] = ati.QueryKind
	}
	return json.Marshal(objectMap)
}
...
func (bti BookmarkTimelineItem) MarshalJSON() ([]byte, error) {
	bti.QueryKind = QueryKindBookmark
	objectMap := make(map[string]interface{})
	...
	if bti.QueryKind != "" {
		objectMap["queryKind"] = bti.QueryKind
	}
	return json.Marshal(objectMap)
}
...
func (eti EntityTimelineItem) MarshalJSON() ([]byte, error) {
	eti.QueryKind = QueryKindEntityTimelineItem
	objectMap := make(map[string]interface{})
	if eti.QueryKind != "" {
		objectMap["queryKind"] = eti.QueryKind
	}
	return json.Marshal(objectMap)
}
...
type EntityTimelineParameters struct {
	// QueryKinds - Array of timeline Item kinds.
	QueryKinds *[]EntityQueryKind `json:"queryKinds,omitempty"`
...
// QueriesErrors timeline Query Errors.
type QueriesErrors struct {
	// QueryKind - the query kind. Possible values include: 'EntityQueryKindActivity', 'EntityQueryKindBookmark', 'EntityQueryKindSecurityAlert'
	QueryKind EntityQueryKind `json:"queryKind,omitempty"`
...
func (sati SecurityAlertTimelineItem) MarshalJSON() ([]byte, error) {
	sati.QueryKind = QueryKindSecurityAlert
	objectMap := make(map[string]interface{})
	if sati.AlertID != nil {
		objectMap["alertId"] = sati.AlertID
	}
	...
	if sati.QueryKind != "" {
		objectMap["queryKind"] = sati.QueryKind
	}
	return json.Marshal(objectMap)
}
...
type TimelineResultsMetadata struct {
	...
	// QueryErrors - information about the failure queries
	QueryErrors *[]QueriesErrors `json:"queryErrors,omitempty"`
}
