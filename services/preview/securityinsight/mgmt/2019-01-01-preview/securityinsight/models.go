...
// ActivityQueryItem represents Activity Query.
type ActivityQueryItem struct {
	// Properties - Properties bag for InsightQueryItem
	Properties *ActivityQueryItemProperties `json:"properties,omitempty"`
	...
	// Type - ARM Type
	Type *string `json:"type,omitempty"`
	// Kind - Possible values include: 'KindEntityQueryItem', 'KindInsight', 'KindActivity'
	Kind KindBasicEntityQueryItem `json:"kind,omitempty"`
}

// MarshalJSON is the custom marshaler for ActivityQueryItem.
func (aqi ActivityQueryItem) MarshalJSON() ([]byte, error) {
	aqi.Kind = KindActivity
	objectMap := make(map[string]interface{})
	if aqi.Properties != nil {
		objectMap["properties"] = aqi.Properties
	}
	if aqi.Name != nil {
		objectMap["name"] = aqi.Name
	}
	if aqi.Type != nil {
		objectMap["type"] = aqi.Type
	}
	if aqi.Kind != "" {
		objectMap["kind"] = aqi.Kind
	}
	return json.Marshal(objectMap)
}

// AsInsightQueryItem is the BasicEntityQueryItem implementation for ActivityQueryItem.
func (aqi ActivityQueryItem) AsInsightQueryItem() (*InsightQueryItem, bool) {
	return nil, false
}

// AsActivityQueryItem is the BasicEntityQueryItem implementation for ActivityQueryItem.
func (aqi ActivityQueryItem) AsActivityQueryItem() (*ActivityQueryItem, bool) {
	return &aqi, true
}

// AsEntityQueryItem is the BasicEntityQueryItem implementation for ActivityQueryItem.
func (aqi ActivityQueryItem) AsEntityQueryItem() (*EntityQueryItem, bool) {
	return nil, false
}

// AsBasicEntityQueryItem is the BasicEntityQueryItem implementation for ActivityQueryItem.
func (aqi ActivityQueryItem) AsBasicEntityQueryItem() (BasicEntityQueryItem, bool) {
	return &aqi, true
}

// ActivityQueryItemProperties represents Activity properties Query.
type ActivityQueryItemProperties struct {
	...
	// EnabledByDefault - Is activity should be enabled by default.
	EnabledByDefault *bool `json:"enabledByDefault,omitempty"`
	// QueryDefinitions - The activity query definitions.
	QueryDefinitions *ActivityQueryItemPropertiesQueryDefinitions `json:"queryDefinitions,omitempty"`
...
// ActivityQueryItemPropertiesQueryDefinitions the activity query definitions.
type ActivityQueryItemPropertiesQueryDefinitions struct {
	// Query - The activity query.
...
type BasicEntityQueryItem interface {
	...
	AsActivityQueryItem() (*ActivityQueryItem, bool)
...
func unmarshalBasicEntityQueryItem(body []byte) (BasicEntityQueryItem, error) {
	...
	case string(KindInsight):
		...
		return iqi, err
	case string(KindActivity):
		var aqi ActivityQueryItem
...
// AsActivityQueryItem is the BasicEntityQueryItem implementation for EntityQueryItem.
func (eqi EntityQueryItem) AsActivityQueryItem() (*ActivityQueryItem, bool) {
	return nil, false
}
...
// AsActivityQueryItem is the BasicEntityQueryItem implementation for InsightQueryItem.
func (iqi InsightQueryItem) AsActivityQueryItem() (*ActivityQueryItem, bool) {
	return nil, false
}
