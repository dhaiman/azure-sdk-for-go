...
type EntitiesClientAPI interface {
	...
	Queries(ctx context.Context, resourceGroupName string, operationalInsightsResourceProvider string, workspaceName string, entityID string, kind securityinsight.EntityQueryKind) (result securityinsight.GetQueriesResponse, err error)
}
