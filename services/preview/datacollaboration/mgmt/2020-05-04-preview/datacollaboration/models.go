...
const (
	// ProposalApprovalStatusActive ...
	ProposalApprovalStatusActive ProposalApprovalStatus = "Active"
	...
	// ProposalApprovalStatusRevoked ...
	ProposalApprovalStatusRevoked ProposalApprovalStatus = "Revoked"
)
...
func PossibleProposalApprovalStatusValues() []ProposalApprovalStatus {
	return []ProposalApprovalStatus{ProposalApprovalStatusActive, ProposalApprovalStatusApproved, ProposalApprovalStatusPending, ProposalApprovalStatusRevoked}
}
...
func PossibleProvisioningStateValues() []ProvisioningState {
	return []ProvisioningState{ProvisioningStateCreating, ProvisioningStateDeleting, ProvisioningStateFailed, ProvisioningStateMoving, ProvisioningStateSucceeded}
}
...
const (
	// HiddenContent ...
	HiddenContent Visibility = "HiddenContent"
	// ShowAll ...
...
func PossibleVisibilityValues() []Visibility {
	return []Visibility{HiddenContent, ShowAll}
}
...
type DataAssetProperties struct {
	...
	Description *string `json:"description,omitempty"`
	// ProvisioningState - READ-ONLY; Provisioning state of the DataAsset. Possible values include: 'ProvisioningStateSucceeded', 'ProvisioningStateCreating', 'ProvisioningStateDeleting', 'ProvisioningStateMoving', 'ProvisioningStateFailed'
...
func (darl DataAssetReferenceList) dataAssetReferenceListPreparer(ctx context.Context) (*http.Request, error) {
	if darl.NextLink == nil || len(to.String(darl.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
// Participant readonly participant information
type Participant struct {
	// ParticipantID - READ-ONLY; Unique id for identifying a participant
	ParticipantID *string `json:"participantId,omitempty"`
	// ProposalApprovalStatus - READ-ONLY; Current approval status. Possible values include: 'ProposalApprovalStatusPending', 'ProposalApprovalStatusApproved', 'ProposalApprovalStatusActive', 'ProposalApprovalStatusRevoked'
...
func (prl PipelineRunList) pipelineRunListPreparer(ctx context.Context) (*http.Request, error) {
	if prl.NextLink == nil || len(to.String(prl.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
func (psrl PipelineStepRunList) pipelineStepRunListPreparer(ctx context.Context) (*http.Request, error) {
	if psrl.NextLink == nil || len(to.String(psrl.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
type ProposalProperties struct {
	...
	InvitationID *string `json:"invitationId,omitempty"`
	// LastUpdated - READ-ONLY; Timestamp of the last time the proposal or any of its underlying resources were updated.
	LastUpdated *date.Time `json:"lastUpdated,omitempty"`
	// Participants - READ-ONLY; The list of participants participating in the proposal
...
type ScriptReferenceProperties struct {
	// Content - READ-ONLY; The content of the referenced script. null if Visibility is set to HiddenContent.
	...
	ScriptReferenceID *string `json:"scriptReferenceId,omitempty"`
	// Sinks - READ-ONLY; The list of sink parameters in the referenced script. null if Visibility is set to HiddenContent.
	Sinks *[]string `json:"sinks,omitempty"`
	// Sources - READ-ONLY; The list of source parameters in the referenced script. null if Visibility is set to HiddenContent.
	Sources *[]string `json:"sources,omitempty"`
	// Visibility - READ-ONLY; The referenced script visibility modifier. Possible values include: 'ShowAll', 'HiddenContent'
...
type SynapseSparkScriptProperties struct {
	...
	Sources *[]string `json:"sources,omitempty"`
	// Visibility - Script visibility mode. Possible values include: 'ShowAll', 'HiddenContent'
	Visibility Visibility `json:"visibility,omitempty"`
}
...
type WorkspaceProperties struct {
	// ProvisioningState - READ-ONLY; Provisioning state of the Workspace. Possible values include: 'ProvisioningStateSucceeded', 'ProvisioningStateCreating', 'ProvisioningStateDeleting', 'ProvisioningStateMoving', 'ProvisioningStateFailed'
	ProvisioningState ProvisioningState `json:"provisioningState,omitempty"`
	// UserEmail - READ-ONLY; Email of the user who created the resource
	UserEmail *string `json:"userEmail,omitempty"`
	// UserName - READ-ONLY; Name of the user who created the resource
