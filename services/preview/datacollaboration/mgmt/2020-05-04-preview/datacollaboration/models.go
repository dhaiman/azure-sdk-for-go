...
// DataAssetReferenceResourceReferenceProperties properties for dataAssetReference resource reference used to
// only allow access if the resource is used within the specified Azure dataAssetReference.
type DataAssetReferenceResourceReferenceProperties struct {
	// DataAssetReferenceID - READ-ONLY; The unique identifier of the referenced data asset
	DataAssetReferenceID *string `json:"dataAssetReferenceId,omitempty"`
...
// DataAssetResourceReference resourceReference used to only allow access if the resource is used within the
// specified Azure dataAsset.
...
// DataAssetResourceReferenceProperties properties for dataAsset resource reference used to only allow access
// if the resource is used within the specified Azure dataAsset.
...
type PipelineRunParameters struct {
	// PipelineRunMode - Mode of pipeline run used. Possible values include: 'Production', 'Test'
...
type PipelineRunProperties struct {
	...
	// PipelineRunStatus - READ-ONLY; Pipeline run status. Possible values include: 'Succeeded', 'Failed', 'InProgress', 'Preparing', 'Queued', 'Unknown', 'Cancelled', 'Canceling'
...
func NewResourceReferenceListPage(getNextPage func(context.Context, ResourceReferenceList) (ResourceReferenceList, error)) ResourceReferenceListPage {
	return ResourceReferenceListPage{fn: getNextPage}
}
...
// ScriptReferenceResourceReference resourceReference used to only allow access if the resource is used within
...
// ScriptReferenceResourceReferenceProperties properties for scriptReference resource reference used to only
// allow access if the resource is used within the specified Azure scriptReference.
type ScriptReferenceResourceReferenceProperties struct {
	...
	// ScriptKind - READ-ONLY; Kind of the referenced script. Possible values include: 'SynapseSpark'
	ScriptKind ScriptKind `json:"scriptKind,omitempty"`
	// ScriptReferenceID - READ-ONLY; The unique identifier of the referenced scriptReference
	ScriptReferenceID *string `json:"scriptReferenceId,omitempty"`
...
// ScriptResourceReferenceProperties properties for script resource reference used to only allow access if the
// resource is used within the specified Azure script.
