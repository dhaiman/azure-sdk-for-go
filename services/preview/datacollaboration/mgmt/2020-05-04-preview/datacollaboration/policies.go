...
func (client PoliciesClient) ListByEntitlement(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (result PolicyListPage, err error) {
	if tracing.IsEnabled() {
...
func (client PoliciesClient) ListByEntitlementPreparer(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"entitlementName":   autorest.Encode("path", entitlementName),
		"proposalName":      autorest.Encode("path", proposalName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
func (client PoliciesClient) ListByEntitlementComplete(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (result PolicyListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PoliciesClient.ListByEntitlement")
		defer func() {
			sc := -1
