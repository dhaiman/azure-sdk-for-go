...
func (client ConstraintsClient) ListByEntitlement(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (result ConstraintListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListByEntitlementPreparer(ctx, resourceGroupName, workspaceName, proposalName, entitlementName, skipToken)
	if err != nil {
...
func (client ConstraintsClient) ListByEntitlementPreparer(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"entitlementName":   autorest.Encode("path", entitlementName),
		"proposalName":      autorest.Encode("path", proposalName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
func (client ConstraintsClient) ListByEntitlementComplete(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (result ConstraintListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ConstraintsClient.ListByEntitlement")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListByEntitlement(ctx, resourceGroupName, workspaceName, proposalName, entitlementName, skipToken)
	return
}
