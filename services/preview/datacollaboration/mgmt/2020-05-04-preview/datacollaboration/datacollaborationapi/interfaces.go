...
type PipelinesClientAPI interface {
	...
	ListByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string, skipToken string) (result datacollaboration.PipelineListPage, err error)
	ListByWorkspaceComplete(ctx context.Context, resourceGroupName string, workspaceName string, skipToken string) (result datacollaboration.PipelineListIterator, err error)
	Run(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string) (result datacollaboration.PipelineRun, err error)
}
...
type PipelineRunsClientAPI interface {
	Cancel(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, pipelineRunName string) (result datacollaboration.PipelineRunsCancelFuture, err error)
	Get(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, pipelineRunName string) (result datacollaboration.PipelineRun, err error)
	ListByPipeline(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, skipToken string) (result datacollaboration.PipelineRunListPage, err error)
	ListByPipelineComplete(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, skipToken string) (result datacollaboration.PipelineRunListIterator, err error)
}
...
type PipelineStepRunsClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, pipelineRunName string, pipelineStepRunID string) (result datacollaboration.PipelineStepRun, err error)
	ListByPipelineRun(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, pipelineRunName string, skipToken string) (result datacollaboration.PipelineStepRunListPage, err error)
	ListByPipelineRunComplete(ctx context.Context, resourceGroupName string, workspaceName string, pipelineName string, pipelineRunName string, skipToken string) (result datacollaboration.PipelineStepRunListIterator, err error)
}
...
type ProposalsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, proposal datacollaboration.Proposal) (result datacollaboration.Proposal, err error)
...
type EntitlementsClientAPI interface {
	...
	ListByProposal(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, skipToken string) (result datacollaboration.EntitlementListPage, err error)
	ListByProposalComplete(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, skipToken string) (result datacollaboration.EntitlementListIterator, err error)
}
...
type ConstraintsClientAPI interface {
	...
	ListByEntitlement(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (result datacollaboration.ConstraintListPage, err error)
	ListByEntitlementComplete(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (result datacollaboration.ConstraintListIterator, err error)
}
...
type PoliciesClientAPI interface {
	...
	ListByEntitlement(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (result datacollaboration.PolicyListPage, err error)
	ListByEntitlementComplete(ctx context.Context, resourceGroupName string, workspaceName string, proposalName string, entitlementName string, skipToken string) (result datacollaboration.PolicyListIterator, err error)
}
