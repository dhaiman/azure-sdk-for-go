...
func (bsp *BlobServiceProperties) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var xxxBlobServiceProperties BlobServicePropertiesProperties
				err = json.Unmarshal(*v, &xxxBlobServiceProperties)
				if err != nil {
					return err
				}
				bsp.BlobServicePropertiesProperties = &xxxBlobServiceProperties
			}
		case "sku":
			if v != nil {
				var sku Sku
