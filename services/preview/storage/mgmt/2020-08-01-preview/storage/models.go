...
type Encryption struct {
	...
	// Identity - Encryption Identity properties when storage account is associated with a UserAssignedIdentity.
	Identity *EncryptionIdentity `json:"identity,omitempty"`
}

// EncryptionIdentity encryption Identity properties when storage account is associated with a
// UserAssignedIdentity.
type EncryptionIdentity struct {
	// UserAssignedIdentity - ResourceID of the UserAssignedIdentity to be associated with the storage account.
