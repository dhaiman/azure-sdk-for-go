...
// ResourceSkusClient is the bing Management Client
...
// List gets the list of Microsoft.Bing SKUs available for your Subscription.
func (client ResourceSkusClient) List(ctx context.Context) (result ResourceSkusResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("bing.ResourceSkusClient", "List", err.Error())
	}

	result.fn = client.listNextResults
	req, err := client.ListPreparer(ctx)
	if err != nil {
		err = autorest.NewErrorWithError(err, "bing.ResourceSkusClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "bing.ResourceSkusClient", "List", resp, "Failure sending request")
		return
	}

	result.rsr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "bing.ResourceSkusClient", "List", resp, "Failure responding to request")
	}
...
func (client ResourceSkusClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.Bing/skus", pathParameters),
...
func (client ResourceSkusClient) listNextResults(ctx context.Context, lastResults ResourceSkusResult) (result ResourceSkusResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "bing.ResourceSkusClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "bing.ResourceSkusClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "bing.ResourceSkusClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
