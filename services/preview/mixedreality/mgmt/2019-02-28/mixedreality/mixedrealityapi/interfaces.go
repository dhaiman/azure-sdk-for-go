...
import (
    ...
    "github.com/Azure/go-autorest/autorest"
        ...
        type OperationsClientAPI interface {
            List(ctx context.Context) (result mixedreality.OperationListResultPage, err error)
                ListComplete(ctx context.Context) (result mixedreality.OperationListResultIterator, err error)
        }
