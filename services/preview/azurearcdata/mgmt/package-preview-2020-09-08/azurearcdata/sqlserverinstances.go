...
func (client SQLServerInstancesClient) Create(ctx context.Context, resourceGroupName string, SQLServerInstanceName string, SQLServerInstance SQLServerInstance) (result SQLServerInstance, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: SQLServerInstance,
			Constraints: []validation.Constraint{{Target: "SQLServerInstance.SQLServerInstanceProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "SQLServerInstance.SQLServerInstanceProperties.Version", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "SQLServerInstance.SQLServerInstanceProperties.Edition", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "SQLServerInstance.SQLServerInstanceProperties.ContainerResourceID", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "SQLServerInstance.SQLServerInstanceProperties.VCore", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "SQLServerInstance.SQLServerInstanceProperties.Status", Name: validation.Null, Rule: true, Chain: nil},
				}}}}}); err != nil {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLServerInstancesClient", "Create", resp, "Failure sending request")
		return
	}

	result, err = client.CreateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLServerInstancesClient", "Create", resp, "Failure responding to request")
	}
