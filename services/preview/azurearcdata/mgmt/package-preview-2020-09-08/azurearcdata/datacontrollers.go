...
func (client DataControllersClient) PutDataController(ctx context.Context, resourceGroupName string, dataControllerResource DataControllerResource, dataControllerName string) (result DataControllerResource, err error) {
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "azurearcdata.DataControllersClient", "PutDataController", resp, "Failure sending request")
		return
	}

	result, err = client.PutDataControllerResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.DataControllersClient", "PutDataController", resp, "Failure responding to request")
	}
