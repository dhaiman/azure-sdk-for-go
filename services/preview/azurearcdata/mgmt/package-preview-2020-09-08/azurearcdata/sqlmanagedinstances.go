...
func (client SQLManagedInstancesClient) Create(ctx context.Context, resourceGroupName string, SQLManagedInstanceName string, SQLManagedInstance SQLManagedInstance) (result SQLManagedInstance, err error) {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLManagedInstancesClient", "Create", resp, "Failure sending request")
		return
	}

	result, err = client.CreateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLManagedInstancesClient", "Create", resp, "Failure responding to request")
	}
