...
type SQLPoolResourceProperties struct {
	...
	CreationDate *date.Time `json:"creationDate,omitempty"`
	// StorageAccountType - The storage account type used to store data and backups for this sql pool. The supported options are GRS (Geo-Redundant Storage) and LRS (Locally Redundant Storage). Possible values include: 'GRS', 'LRS'
