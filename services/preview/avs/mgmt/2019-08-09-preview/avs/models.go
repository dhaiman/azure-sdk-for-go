...
// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future *VMWareDatastoreBackingsCreateFuture) Result(client VMWareDatastoreBackingsClient) (r Resource, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	if r.Response.Response, err = future.GetResult(sender); err == nil && r.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "avs.VMWareDatastoreBackingsCreateFuture", "Result", r.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future *VMWareDatastoreCreateFuture) Result(client VMWareDatastoreClient) (r Resource, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	if r.Response.Response, err = future.GetResult(sender); err == nil && r.Response.Response.StatusCode != http.StatusNoContent {
		r, err = client.CreateResponder(r.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "avs.VMWareDatastoreCreateFuture", "Result", r.Response.Response, "Failure responding to request")
		}
	}
	return
}
