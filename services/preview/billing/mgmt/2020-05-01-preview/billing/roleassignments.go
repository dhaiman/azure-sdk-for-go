...
func (client RoleAssignmentsClient) AddByBillingAccount(ctx context.Context, billingAccountName string, parameters RoleAssignmentRequestProperties) (result RoleAssignment, err error) {
...
func (client RoleAssignmentsClient) AddByBillingAccountPreparer(ctx context.Context, billingAccountName string, parameters RoleAssignmentRequestProperties) (*http.Request, error) {
...
func (client RoleAssignmentsClient) AddByBillingAccountResponder(resp *http.Response) (result RoleAssignment, err error) {
...
// parameters - request parameters that are provided to the create billing role assignment operation.
func (client RoleAssignmentsClient) AddByBillingProfile(ctx context.Context, billingAccountName string, billingProfileName string, parameters RoleAssignmentRequestProperties) (result RoleAssignment, err error) {
	if tracing.IsEnabled() {
...
func (client RoleAssignmentsClient) AddByBillingProfilePreparer(ctx context.Context, billingAccountName string, billingProfileName string, parameters RoleAssignmentRequestProperties) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"billingAccountName": autorest.Encode("path", billingAccountName),
...
// closes the http.Response Body.
func (client RoleAssignmentsClient) AddByBillingProfileResponder(resp *http.Response) (result RoleAssignment, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK, http.StatusCreated),
		autorest.ByUnmarshallingJSON(&result),
...
// parameters - request parameters that are provided to the create billing role assignment operation.
func (client RoleAssignmentsClient) AddByInvoiceSection(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, parameters RoleAssignmentRequestProperties) (result RoleAssignment, err error) {
	if tracing.IsEnabled() {
...
func (client RoleAssignmentsClient) AddByInvoiceSectionPreparer(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, parameters RoleAssignmentRequestProperties) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"billingAccountName": autorest.Encode("path", billingAccountName),
		"billingProfileName": autorest.Encode("path", billingProfileName),
...
// closes the http.Response Body.
func (client RoleAssignmentsClient) AddByInvoiceSectionResponder(resp *http.Response) (result RoleAssignment, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK, http.StatusCreated),
		autorest.ByUnmarshallingJSON(&result),
