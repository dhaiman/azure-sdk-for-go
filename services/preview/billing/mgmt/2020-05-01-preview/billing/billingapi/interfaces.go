...
type RoleAssignmentsClientAPI interface {
	AddByBillingAccount(ctx context.Context, billingAccountName string, parameters billing.RoleAssignmentRequestProperties) (result billing.RoleAssignment, err error)
	AddByBillingProfile(ctx context.Context, billingAccountName string, billingProfileName string, parameters billing.RoleAssignmentRequestProperties) (result billing.RoleAssignment, err error)
	AddByInvoiceSection(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, parameters billing.RoleAssignmentRequestProperties) (result billing.RoleAssignment, err error)
