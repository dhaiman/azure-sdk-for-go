...
type PermissionsClientAPI interface {
	...
	ListByDepartment(ctx context.Context, billingAccountName string, departmentName string) (result billing.PermissionsListResultPage, err error)
	ListByDepartmentComplete(ctx context.Context, billingAccountName string, departmentName string) (result billing.PermissionsListResultIterator, err error)
	ListByEnrollmentAccount(ctx context.Context, billingAccountName string, enrollmentAccountName string) (result billing.PermissionsListResultPage, err error)
	ListByEnrollmentAccountComplete(ctx context.Context, billingAccountName string, enrollmentAccountName string) (result billing.PermissionsListResultIterator, err error)
...
type RoleAssignmentsClientAPI interface {
	...
	DeleteByDepartment(ctx context.Context, billingAccountName string, departmentName string, billingRoleAssignmentName string) (result billing.RoleAssignment, err error)
	DeleteByEnrollmentAccount(ctx context.Context, billingAccountName string, enrollmentAccountName string, billingRoleAssignmentName string) (result billing.RoleAssignment, err error)
	...
	GetByDepartment(ctx context.Context, billingAccountName string, departmentName string, billingRoleAssignmentName string) (result billing.RoleAssignment, err error)
	GetByEnrollmentAccount(ctx context.Context, billingAccountName string, enrollmentAccountName string, billingRoleAssignmentName string) (result billing.RoleAssignment, err error)
	...
	ListByDepartment(ctx context.Context, billingAccountName string, departmentName string) (result billing.RoleAssignmentListResultPage, err error)
	ListByDepartmentComplete(ctx context.Context, billingAccountName string, departmentName string) (result billing.RoleAssignmentListResultIterator, err error)
	ListByEnrollmentAccount(ctx context.Context, billingAccountName string, enrollmentAccountName string) (result billing.RoleAssignmentListResultPage, err error)
	ListByEnrollmentAccountComplete(ctx context.Context, billingAccountName string, enrollmentAccountName string) (result billing.RoleAssignmentListResultIterator, err error)
...
// RoleAssignmentsGroupClientAPI contains the set of methods on the RoleAssignmentsGroupClient type.
type RoleAssignmentsGroupClientAPI interface {
	Put(ctx context.Context, billingAccountName string, billingRoleAssignmentName string, parameters billing.RoleAssignment) (result billing.RoleAssignment, err error)
}

var _ RoleAssignmentsGroupClientAPI = (*billing.RoleAssignmentsGroupClient)(nil)

// EnrollmentDepartmentRoleAssignmentsClientAPI contains the set of methods on the EnrollmentDepartmentRoleAssignmentsClient type.
type EnrollmentDepartmentRoleAssignmentsClientAPI interface {
	Put(ctx context.Context, billingAccountName string, departmentName string, billingRoleAssignmentName string, parameters billing.RoleAssignment) (result billing.RoleAssignment, err error)
}

var _ EnrollmentDepartmentRoleAssignmentsClientAPI = (*billing.EnrollmentDepartmentRoleAssignmentsClient)(nil)

// EnrollmentAccountRoleAssignmentsClientAPI contains the set of methods on the EnrollmentAccountRoleAssignmentsClient type.
type EnrollmentAccountRoleAssignmentsClientAPI interface {
	Put(ctx context.Context, billingAccountName string, enrollmentAccountName string, billingRoleAssignmentName string, parameters billing.RoleAssignment) (result billing.RoleAssignment, err error)
}

var _ EnrollmentAccountRoleAssignmentsClientAPI = (*billing.EnrollmentAccountRoleAssignmentsClient)(nil)
