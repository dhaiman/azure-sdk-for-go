...
type TransfersClientAPI interface {
	...
	Initiate(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, transferName string, parameters billing.InitiateTransferRequest) (result billing.TransferDetails, err error)
...
type PartnerTransfersClientAPI interface {
	...
	Initiate(ctx context.Context, billingAccountName string, customerName string, transferName string, parameters billing.InitiateTransferRequest) (result billing.PartnerTransferDetails, err error)
