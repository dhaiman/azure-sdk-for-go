...
func (client RecipientTransfersClient) AcceptPreparer(ctx context.Context, transferName string, parameters AcceptTransferRequest) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/providers/Microsoft.Billing/transfers/{transferName}/accept", pathParameters),
...
func (client RecipientTransfersClient) DeclinePreparer(ctx context.Context, transferName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/providers/Microsoft.Billing/transfers/{transferName}/decline", pathParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client RecipientTransfersClient) ValidatePreparer(ctx context.Context, transferName string, parameters AcceptTransferRequest) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/providers/Microsoft.Billing/transfers/{transferName}/validate", pathParameters),
		autorest.WithJSON(parameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
