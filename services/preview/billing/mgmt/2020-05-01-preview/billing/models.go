...
type AccountProperties struct {
	...
	// IsTransitioned - READ-ONLY; Specifies if the billing account has transitioned from agreement type Microsoft Online Service Program to agreement type Microsoft Customer Agreement.
	IsTransitioned *bool `json:"isTransitioned,omitempty"`
}
...
type ProfileProperties struct {
	...
	HasReadAccess *bool `json:"hasReadAccess,omitempty"`
	// IsTransitioned - READ-ONLY; Specifies if the billing profile was created during transition of the billing account from agreement type Microsoft Online Service Program to agreement type Microsoft Customer Agreement.
	IsTransitioned *bool `json:"isTransitioned,omitempty"`
