...
func (client TransfersClient) Initiate(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, transferName string, parameters InitiateTransferRequest) (result TransferDetails, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.InitiatePreparer(ctx, billingAccountName, billingProfileName, invoiceSectionName, transferName, parameters)
	if err != nil {
...
func (client TransfersClient) InitiatePreparer(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, transferName string, parameters InitiateTransferRequest) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"billingAccountName": autorest.Encode("path", billingAccountName),
		"billingProfileName": autorest.Encode("path", billingProfileName),
		"invoiceSectionName": autorest.Encode("path", invoiceSectionName),
