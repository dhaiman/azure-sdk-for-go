...
func (client ConnectedClusterClient) Create(ctx context.Context, resourceGroupName string, clusterName string, connectedCluster ConnectedCluster) (result ConnectedCluster, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: connectedCluster,
			Constraints: []validation.Constraint{{Target: "connectedCluster.Location", Name: validation.Null, Rule: true, Chain: nil},
				{Target: "connectedCluster.Tags", Name: validation.Null, Rule: true, Chain: nil},
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterClient", "Create", resp, "Failure sending request")
		return
	}

	result, err = client.CreateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterClient", "Create", resp, "Failure responding to request")
	}
...
func (client ConnectedClusterClient) CreatePreparer(ctx context.Context, resourceGroupName string, clusterName string, connectedCluster ConnectedCluster) (*http.Request, error) {
	...
	const APIVersion = "2019-09-01-privatepreview"
...
func (client ConnectedClusterClient) CreateSender(req *http.Request) (*http.Response, error) {
...
// resourceGroupName - the name of the resource group to which the kubernetes cluster is registered.
// clusterName - the name of the Kubernetes cluster on which get is called.
func (client ConnectedClusterClient) Delete(ctx context.Context, resourceGroupName string, clusterName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterClient", "Delete", resp, "Failure responding to request")
	}
...
// http.Response Body if it receives an error.
func (client ConnectedClusterClient) DeleteSender(req *http.Request) (*http.Response, error) {
	sd := autorest.GetSendDecorators(req.Context(), azure.DoRetryWithRegistration(client.Client))
	return autorest.SendWithSender(client, req, sd...)
}
...
// ListCredentials API to fetch endpoint and credential details to connect to the K8s cluster’s API server via Azure
// Parameters:
// resourceGroupName - the name of the resource group to which the kubernetes cluster is registered.
// clusterName - the name of the Kubernetes cluster on which get is called.
func (client ConnectedClusterClient) ListCredentials(ctx context.Context, resourceGroupName string, clusterName string) (result ConnectedClusterAccessProfile, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ConnectedClusterClient.ListCredentials")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	req, err := client.ListCredentialsPreparer(ctx, resourceGroupName, clusterName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterClient", "ListCredentials", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterClient", "ListCredentials", resp, "Failure sending request")
		return
	}

	result, err = client.ListCredentialsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterClient", "ListCredentials", resp, "Failure responding to request")
	}
...
func (client ConnectedClusterClient) ListCredentialsPreparer(ctx context.Context, resourceGroupName string, clusterName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"clusterName":       autorest.Encode("path", clusterName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	...
	preparer := autorest.CreatePreparer(
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Kubernetes/connectedClusters/{clusterName}/listCredentials", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// http.Response Body if it receives an error.
func (client ConnectedClusterClient) ListCredentialsSender(req *http.Request) (*http.Response, error) {
	sd := autorest.GetSendDecorators(req.Context(), azure.DoRetryWithRegistration(client.Client))
	return autorest.SendWithSender(client, req, sd...)
}
...
// closes the http.Response Body.
func (client ConnectedClusterClient) ListCredentialsResponder(resp *http.Response) (result ConnectedClusterAccessProfile, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
