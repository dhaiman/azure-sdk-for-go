...
func (client OperationsClient) Get(ctx context.Context) (result OperationListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.OperationsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "kubernetes.OperationsClient", "Get", resp, "Failure sending request")
		return
	}

	result.ol, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.OperationsClient", "Get", resp, "Failure responding to request")
	}
...
func (client OperationsClient) getNextResults(ctx context.Context, lastResults OperationList) (result OperationList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "kubernetes.OperationsClient", "getNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "kubernetes.OperationsClient", "getNextResults", resp, "Failure sending next results request")
	}
	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.OperationsClient", "getNextResults", resp, "Failure responding to next results request")
	}
	return
}
