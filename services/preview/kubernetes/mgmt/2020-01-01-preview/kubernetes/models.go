...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/kubernetes/mgmt/2020-01-01-preview/kubernetes"
...
type ConnectedCluster struct {
	...
	// Type - READ-ONLY; Type of the resource requested
...
func (future *ConnectedClusterCreateFuture) Result(client ConnectedClusterClient) (cc ConnectedCluster, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("kubernetes.ConnectedClusterCreateFuture")
		return
	}
	...
	if cc.Response.Response, err = future.GetResult(sender); err == nil && cc.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterCreateFuture", "Result", cc.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *ConnectedClusterDeleteFuture) Result(client ConnectedClusterClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "kubernetes.ConnectedClusterDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("kubernetes.ConnectedClusterDeleteFuture")
		return
	}
...
type ConnectedClusterIdentity struct {
	...
	TenantID *string `json:"tenantId,omitempty"`
	// Type - The type of identity used for the connected cluster. The type 'SystemAssigned, includes a system created identity.
	Type *string `json:"type,omitempty"`
}
...
type ConnectedClusterProxyProfile struct {
	autorest.Response `json:"-"`
	// ProxyConnection - Endpoint and authentication details to connect to proxy
	ProxyConnection *string `json:"proxyConnection,omitempty"`
}
...
type CredentialResult struct {
	...
	Name *string `json:"name,omitempty"`
	// Kubeconfig - READ-ONLY; Base64-encoded Kubernetes configuration file.
