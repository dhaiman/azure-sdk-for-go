...
const (
	...
	// SensorStatusNotActivated ...
	SensorStatusNotActivated SensorStatus = "NotActivated"
)
...
func PossibleSensorStatusValues() []SensorStatus {
	return []SensorStatus{SensorStatusConnected, SensorStatusDisconnected, SensorStatusNotActivated}
}
