...
// SourceBasicAssessmentResourceDetails enumerates the values for source basic assessment resource details.
type SourceBasicAssessmentResourceDetails string

const (
	// SourceBasicAssessmentResourceDetailsSourceAssessmentResourceDetails ...
	SourceBasicAssessmentResourceDetailsSourceAssessmentResourceDetails SourceBasicAssessmentResourceDetails = "AssessmentResourceDetails"
	// SourceBasicAssessmentResourceDetailsSourceAws ...
	SourceBasicAssessmentResourceDetailsSourceAws SourceBasicAssessmentResourceDetails = "Aws"
	// SourceBasicAssessmentResourceDetailsSourceAzure ...
	SourceBasicAssessmentResourceDetailsSourceAzure SourceBasicAssessmentResourceDetails = "Azure"
	// SourceBasicAssessmentResourceDetailsSourceGcp ...
	SourceBasicAssessmentResourceDetailsSourceGcp SourceBasicAssessmentResourceDetails = "Gcp"
	// SourceBasicAssessmentResourceDetailsSourceOnPremise ...
	SourceBasicAssessmentResourceDetailsSourceOnPremise SourceBasicAssessmentResourceDetails = "OnPremise"
)

// PossibleSourceBasicAssessmentResourceDetailsValues returns an array of possible values for the SourceBasicAssessmentResourceDetails const type.
func PossibleSourceBasicAssessmentResourceDetailsValues() []SourceBasicAssessmentResourceDetails {
	return []SourceBasicAssessmentResourceDetails{SourceBasicAssessmentResourceDetailsSourceAssessmentResourceDetails, SourceBasicAssessmentResourceDetailsSourceAws, SourceBasicAssessmentResourceDetailsSourceAzure, SourceBasicAssessmentResourceDetailsSourceGcp, SourceBasicAssessmentResourceDetailsSourceOnPremise}
}
