...
type AlertSimulatorRequestBody struct {
	// BasicAlertSimulatorRequestProperties - Alert Simulator request body data.
	BasicAlertSimulatorRequestProperties `json:"properties,omitempty"`
}

// MarshalJSON is the custom marshaler for AlertSimulatorRequestBody.
func (asrb AlertSimulatorRequestBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	objectMap["properties"] = asrb.BasicAlertSimulatorRequestProperties
	return json.Marshal(objectMap)
}
...
func (asrb *AlertSimulatorRequestBody) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				basicAlertSimulatorRequestProperties, err := unmarshalBasicAlertSimulatorRequestProperties(*v)
				if err != nil {
					return err
				}
				asrb.BasicAlertSimulatorRequestProperties = basicAlertSimulatorRequestProperties
			}
		}
	}
...
// BasicAlertSimulatorRequestProperties alert Simulation request properties.
...
// AlertSimulatorRequestProperties alert Simulation request properties.
