...
func (client AlertsClient) SimulateAlerts(ctx context.Context) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.SimulateAlertsPreparer(ctx)
	if err != nil {
...
func (client AlertsClient) SimulateAlertsPreparer(ctx context.Context) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.Security/locations/centralus/alerts/default/simulate", pathParameters),
