...
func (client OnPremiseIotSensorsClient) DownloadResetPassword(ctx context.Context, onPremiseIotSensorName string, applianceID string) (result ReadCloser, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DownloadResetPasswordPreparer(ctx, onPremiseIotSensorName, applianceID)
	if err != nil {
...
func (client OnPremiseIotSensorsClient) DownloadResetPasswordPreparer(ctx context.Context, onPremiseIotSensorName string, applianceID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"onPremiseIotSensorName": autorest.Encode("path", onPremiseIotSensorName),
		"subscriptionId":         autorest.Encode("path", client.SubscriptionID),
	}
