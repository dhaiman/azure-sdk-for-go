...
type IotSensorsClientAPI interface {
	...
	DownloadResetPassword(ctx context.Context, scope string, iotSensorName string, applianceID string) (result security.ReadCloser, err error)
...
type OnPremiseIotSensorsClientAPI interface {
	...
	DownloadResetPassword(ctx context.Context, onPremiseIotSensorName string, applianceID string) (result security.ReadCloser, err error)
