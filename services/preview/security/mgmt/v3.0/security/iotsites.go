	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: iotSitesModel,
			Constraints: []validation.Constraint{{Target: "iotSitesModel.IotSiteProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "iotSitesModel.IotSiteProperties.DisplayName", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "iotSitesModel.IotSiteProperties.Tags", Name: validation.Null, Rule: true, Chain: nil},
				}}}}}); err != nil {
