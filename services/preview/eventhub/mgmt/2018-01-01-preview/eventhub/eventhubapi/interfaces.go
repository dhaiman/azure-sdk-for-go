...
type DisasterRecoveryConfigsClientAPI interface {
	...
	CreateOrUpdate(ctx context.Context, resourceGroupName string, namespaceName string, alias string, parameters eventhub.ArmDisasterRecovery) (result eventhub.DisasterRecoveryConfigsCreateOrUpdateFuture, err error)
