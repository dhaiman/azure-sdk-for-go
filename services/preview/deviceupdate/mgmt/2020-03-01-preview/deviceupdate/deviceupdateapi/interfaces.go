...
type AccountsClientAPI interface {
	...
	Update(ctx context.Context, resourceGroupName string, accountName string, tagUpdatePayload deviceupdate.TagUpdate) (result deviceupdate.Account, err error)
}
...
type OperationsClientAPI interface {
	List(ctx context.Context) (result deviceupdate.OperationsListPage, err error)
	ListComplete(ctx context.Context) (result deviceupdate.OperationsListIterator, err error)
}
