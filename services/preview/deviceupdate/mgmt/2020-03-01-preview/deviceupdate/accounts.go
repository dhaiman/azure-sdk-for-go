	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: accountName,
			Constraints: []validation.Constraint{{Target: "accountName", Name: validation.MaxLength, Rule: 24, Chain: nil},
				...
				{Target: "accountName", Name: validation.Pattern, Rule: `[a-z][a-z0-9]+`, Chain: nil}}}}); err != nil {
...
// Update updates account's tags.
// Parameters:
// resourceGroupName - the resource group name.
// accountName - account name.
// tagUpdatePayload - updated tags.
func (client AccountsClient) Update(ctx context.Context, resourceGroupName string, accountName string, tagUpdatePayload TagUpdate) (result Account, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.UpdatePreparer(ctx, resourceGroupName, accountName, tagUpdatePayload)
	if err != nil {
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "deviceupdate.AccountsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "deviceupdate.AccountsClient", "Update", resp, "Failure responding to request")
	}
...
func (client AccountsClient) UpdatePreparer(ctx context.Context, resourceGroupName string, accountName string, tagUpdatePayload TagUpdate) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"accountName":       autorest.Encode("path", accountName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
