...
// AsyncOperationsClientAPI contains the set of methods on the AsyncOperationsClient type.
type AsyncOperationsClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, location string, operationGUID string) (result redis.OperationResult, err error)
}

var _ AsyncOperationsClientAPI = (*redis.AsyncOperationsClient)(nil)
