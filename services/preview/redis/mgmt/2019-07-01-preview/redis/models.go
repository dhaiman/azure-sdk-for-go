...
type OperationResult struct {
	...
	Name *string `json:"name,omitempty"`
	// Status - status of the Operation result. Possible values include: 'Succeeded', 'Failed', 'Canceled', 'InProgress'
	...
	// Error - Error for the async operation.
...
func (or OperationResult) MarshalJSON() ([]byte, error) {
	...
	if or.Properties != nil {
		objectMap["properties"] = or.Properties
	}
	if or.Error != nil {
...
// OperationResultError error for the async operation.
