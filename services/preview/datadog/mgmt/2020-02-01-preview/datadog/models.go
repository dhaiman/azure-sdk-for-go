...
type OrganizationProperties struct {
	...
	// IdpMetadata - The XML metadata required to setup single sign on during organization creation.
...
func (op OrganizationProperties) MarshalJSON() ([]byte, error) {
	...
	if op.IdpMetadata != nil {
		objectMap["idpMetadata"] = op.IdpMetadata
	}
...
type SingleSignOnProperties struct {
	// SingleSignOnState - This state of single sign-on functionality.
	SingleSignOnState *string `json:"singleSignOnState,omitempty"`
	// MetadataXML - The metadataXML from the Azure AD app to setup SSO.
