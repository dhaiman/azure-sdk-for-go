...
type ClientAPI interface {
	...
	GetSubscription(ctx context.Context, subscriptionID string) (result subscription.PutSubscriptionResponse, err error)
	PutSubscription(ctx context.Context, subscriptionID string, body subscription.PutSubscriptionRequest) (result subscription.PutSubscriptionFuture, err error)
