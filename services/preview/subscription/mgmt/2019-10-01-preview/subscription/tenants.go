...
func NewTenantsClient(ignoreResourceCheck *bool) TenantsClient {
	return NewTenantsClientWithBaseURI(DefaultBaseURI, ignoreResourceCheck)
}
...
func NewTenantsClientWithBaseURI(baseURI string, ignoreResourceCheck *bool) TenantsClient {
	return TenantsClient{NewWithBaseURI(baseURI, ignoreResourceCheck)}
}
