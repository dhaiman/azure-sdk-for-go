...
// Parameters:
// subscriptionID - subscription Id.
func (client Client) GetSubscription(ctx context.Context, subscriptionID string) (result PutSubscriptionResponse, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetSubscriptionPreparer(ctx, subscriptionID)
	if err != nil {
		err = autorest.NewErrorWithError(err, "subscription.Client", "GetSubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "subscription.Client", "GetSubscription", resp, "Failure sending request")
		return
	}

	result, err = client.GetSubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "subscription.Client", "GetSubscription", resp, "Failure responding to request")
	}
...
func (client Client) GetSubscriptionPreparer(ctx context.Context, subscriptionID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", subscriptionID),
	}
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/providers/Microsoft.Subscription/subscriptions/{subscriptionId}", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// closes the http.Response Body.
func (client Client) GetSubscriptionResponder(resp *http.Response) (result PutSubscriptionResponse, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK, http.StatusAccepted),
		autorest.ByUnmarshallingJSON(&result),
...
// PutSubscription the operation to create a new subscription or update the display name of an existing subscription.
// Parameters:
// subscriptionID - subscription Id.
func (client Client) PutSubscription(ctx context.Context, subscriptionID string, body PutSubscriptionRequest) (result PutSubscriptionFuture, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/Client.PutSubscription")
		defer func() {
			sc := -1
			if result.Response() != nil {
				sc = result.Response().StatusCode
		...
		{TargetValue: body,
			Constraints: []validation.Constraint{{Target: "body.Properties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "body.Properties.DisplayName", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "body.Properties.SkuID", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "body.Properties.BillingScope", Name: validation.Null, Rule: true, Chain: nil},
				}}}}}); err != nil {
		return result, validation.NewError("subscription.Client", "PutSubscription", err.Error())
	}

	req, err := client.PutSubscriptionPreparer(ctx, subscriptionID, body)
	if err != nil {
		err = autorest.NewErrorWithError(err, "subscription.Client", "PutSubscription", nil, "Failure preparing request")
		return
	}

	result, err = client.PutSubscriptionSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "subscription.Client", "PutSubscription", result.Response(), "Failure sending request")
		return
	}
...
// PutSubscriptionPreparer prepares the PutSubscription request.
func (client Client) PutSubscriptionPreparer(ctx context.Context, subscriptionID string, body PutSubscriptionRequest) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", subscriptionID),
	}
...
// PutSubscriptionSender sends the PutSubscription request. The method will close the
// http.Response Body if it receives an error.
func (client Client) PutSubscriptionSender(req *http.Request) (future PutSubscriptionFuture, err error) {
	var resp *http.Response
...
// PutSubscriptionResponder handles the response to the PutSubscription request. The method always
// closes the http.Response Body.
func (client Client) PutSubscriptionResponder(resp *http.Response) (result PutSubscriptionResponse, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK, http.StatusAccepted),
		autorest.ByUnmarshallingJSON(&result),
