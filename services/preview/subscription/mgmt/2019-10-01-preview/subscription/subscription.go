...
func NewClient(ignoreResourceCheck *bool) Client {
	return NewClientWithBaseURI(DefaultBaseURI, ignoreResourceCheck)
}

// NewClientWithBaseURI creates an instance of the Client client using a custom endpoint.  Use this when interacting
// with an Azure cloud that uses a non-standard base URI (sovereign clouds, Azure stack).
func NewClientWithBaseURI(baseURI string, ignoreResourceCheck *bool) Client {
	return Client{NewWithBaseURI(baseURI, ignoreResourceCheck)}
}
...
func (client Client) CancelPreparer(ctx context.Context, subscriptionID string) (*http.Request, error) {
	...
	if client.IgnoreResourceCheck != nil {
		queryParameters["IgnoreResourceCheck"] = autorest.Encode("query", *client.IgnoreResourceCheck)
	}
