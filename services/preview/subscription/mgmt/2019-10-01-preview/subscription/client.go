...
func New(ignoreResourceCheck *bool) BaseClient {
	return NewWithBaseURI(DefaultBaseURI, ignoreResourceCheck)
}

// NewWithBaseURI creates an instance of the BaseClient client using a custom endpoint.  Use this when interacting with
// an Azure cloud that uses a non-standard base URI (sovereign clouds, Azure stack).
func NewWithBaseURI(baseURI string, ignoreResourceCheck *bool) BaseClient {
	return BaseClient{
		Client:              autorest.NewClientWithUserAgent(UserAgent()),
		BaseURI:             baseURI,
		IgnoreResourceCheck: ignoreResourceCheck,
	}
}
