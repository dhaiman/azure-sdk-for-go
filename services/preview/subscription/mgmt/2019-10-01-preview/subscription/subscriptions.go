...
func NewSubscriptionsClient(ignoreResourceCheck *bool) SubscriptionsClient {
	return NewSubscriptionsClientWithBaseURI(DefaultBaseURI, ignoreResourceCheck)
}
...
func NewSubscriptionsClientWithBaseURI(baseURI string, ignoreResourceCheck *bool) SubscriptionsClient {
	return SubscriptionsClient{NewWithBaseURI(baseURI, ignoreResourceCheck)}
}
