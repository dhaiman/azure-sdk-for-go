...
func NewOperationClient(ignoreResourceCheck *bool) OperationClient {
	return NewOperationClientWithBaseURI(DefaultBaseURI, ignoreResourceCheck)
}
...
func NewOperationClientWithBaseURI(baseURI string, ignoreResourceCheck *bool) OperationClient {
	return OperationClient{NewWithBaseURI(baseURI, ignoreResourceCheck)}
}
