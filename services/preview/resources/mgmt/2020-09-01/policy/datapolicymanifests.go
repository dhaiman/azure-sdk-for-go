...
func NewDataPolicyManifestsClient() DataPolicyManifestsClient {
	return NewDataPolicyManifestsClientWithBaseURI(DefaultBaseURI)
}
...
// stack).
func NewDataPolicyManifestsClientWithBaseURI(baseURI string) DataPolicyManifestsClient {
	return DataPolicyManifestsClient{NewWithBaseURI(baseURI)}
}
