...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/streamanalytics/mgmt/2017-04-01-preview/streamanalytics"
...
type AggregateFunctionProperties struct {
	...
	*FunctionConfiguration `json:"properties,omitempty"`
	// Type - Possible values include: 'TypeFunctionProperties', 'TypeScalar', 'TypeAggregateFunctionProperties'
...
func (afp AggregateFunctionProperties) MarshalJSON() ([]byte, error) {
	afp.Type = TypeAggregateFunctionProperties
...
func (afods AzureFunctionOutputDataSource) MarshalJSON() ([]byte, error) {
	...
	objectMap := make(map[string]interface{})
	if afods.FunctionAppName != nil {
		objectMap["functionAppName"] = afods.FunctionAppName
	}
	if afods.FunctionName != nil {
		objectMap["functionName"] = afods.FunctionName
	}
	if afods.APIKey != nil {
		objectMap["apiKey"] = afods.APIKey
	}
	if afods.MaxBatchSize != nil {
		objectMap["maxBatchSize"] = afods.MaxBatchSize
	}
	if afods.MaxBatchCount != nil {
		objectMap["maxBatchCount"] = afods.MaxBatchCount
	}
	if afods.Type != "" {
...
type AzureMachineLearningServiceFunctionBinding struct {
	...
	*AzureMachineLearningServiceFunctionBindingProperties `json:"properties,omitempty"`
	// Type - Possible values include: 'TypeFunctionBinding', 'TypeMicrosoftMachineLearningWebService', 'TypeMicrosoftMachineLearningServices', 'TypeMicrosoftStreamAnalyticsJavascriptUdf', 'TypeMicrosoftStreamAnalyticsCLRUdf'
...
func (asrids AzureSQLReferenceInputDataSource) MarshalJSON() ([]byte, error) {
	...
	objectMap := make(map[string]interface{})
	if asrids.Server != nil {
		objectMap["server"] = asrids.Server
	}
	if asrids.Database != nil {
		objectMap["database"] = asrids.Database
	}
	if asrids.User != nil {
		objectMap["user"] = asrids.User
	}
	if asrids.Password != nil {
		objectMap["password"] = asrids.Password
	}
	if asrids.Table != nil {
		objectMap["table"] = asrids.Table
	}
	if asrids.RefreshType != nil {
		objectMap["refreshType"] = asrids.RefreshType
	}
	if asrids.RefreshRate != nil {
		objectMap["refreshRate"] = asrids.RefreshRate
	}
	if asrids.FullSnapshotQuery != nil {
		objectMap["fullSnapshotQuery"] = asrids.FullSnapshotQuery
	}
	if asrids.DeltaSnapshotQuery != nil {
		objectMap["deltaSnapshotQuery"] = asrids.DeltaSnapshotQuery
	}
	if asrids.Type != "" {
...
type BlobStreamInputDataSource struct {
	...
	*BlobStreamInputDataSourceProperties `json:"properties,omitempty"`
	// Type - Possible values include: 'TypeBasicStreamInputDataSourceTypeStreamInputDataSource', 'TypeBasicStreamInputDataSourceTypeMicrosoftStorageBlob', 'TypeBasicStreamInputDataSourceTypeMicrosoftServiceBusEventHub', 'TypeBasicStreamInputDataSourceTypeMicrosoftDevicesIotHubs'
...
// BasicCompression describes how input data is compressed
type BasicCompression interface {
	AsCompression() (*Compression, bool)
}

// Compression describes how input data is compressed
type Compression struct {
	// Type - Possible values include: 'TypeCompression'
	Type TypeBasicCompression `json:"type,omitempty"`
}

func unmarshalBasicCompression(body []byte) (BasicCompression, error) {
...
func unmarshalBasicCompressionArray(body []byte) ([]BasicCompression, error) {
	...
	cArray := make([]BasicCompression, len(rawMessages))

	for index, rawMessage := range rawMessages {
		c, err := unmarshalBasicCompression(*rawMessage)
		if err != nil {
			return nil, err
		}
		cArray[index] = c
...
// MarshalJSON is the custom marshaler for Compression.
func (c Compression) MarshalJSON() ([]byte, error) {
	c.Type = TypeCompression
	objectMap := make(map[string]interface{})
	if c.Type != "" {
...
// AsCompression is the BasicCompression implementation for Compression.
func (c Compression) AsCompression() (*Compression, bool) {
	return &c, true
}

// AsBasicCompression is the BasicCompression implementation for Compression.
func (c Compression) AsBasicCompression() (BasicCompression, bool) {
	return &c, true
}
...
func unmarshalBasicFunctionProperties(body []byte) (BasicFunctionProperties, error) {
	...
	case string(TypeScalar):
		...
		return sfp, err
	case string(TypeAggregateFunctionProperties):
...
type InputProperties struct {
	...
	Etag        *string          `json:"etag,omitempty"`
	Compression BasicCompression `json:"compression,omitempty"`
...
func (IP *InputProperties) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "compression":
			if v != nil {
				compression, err := unmarshalBasicCompression(*v)
				if err != nil {
					return err
				}
...
type StreamingJobProperties struct {
	...
	// JobType - Describes the type of the job
	...
	// Externals - External Property.
	Externals *External `json:"externals,omitempty"`
	// Cluster - The resource id of cluster which streaming jobs will run on.
...
func (sjp StreamingJobProperties) MarshalJSON() ([]byte, error) {
	...
	if sjp.Identity != nil {
		objectMap["identity"] = sjp.Identity
	}
