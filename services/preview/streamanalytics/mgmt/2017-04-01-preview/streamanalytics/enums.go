...
// TypeBasicCompression enumerates the values for type basic compression.
type TypeBasicCompression string

const (
	// TypeCompression ...
	TypeCompression TypeBasicCompression = "Compression"
)

// PossibleTypeBasicCompressionValues returns an array of possible values for the TypeBasicCompression const type.
func PossibleTypeBasicCompressionValues() []TypeBasicCompression {
	return []TypeBasicCompression{TypeCompression}
}
...
const (
	// TypeAggregateFunctionProperties ...
	TypeAggregateFunctionProperties TypeBasicFunctionProperties = "AggregateFunctionProperties"
...
func PossibleTypeBasicFunctionPropertiesValues() []TypeBasicFunctionProperties {
	return []TypeBasicFunctionProperties{TypeAggregateFunctionProperties, TypeFunctionProperties, TypeScalar}
}
