...
type AaaaRecord struct {
	// Ipv6AddressSPAM - The IPv6 address of this AAAA record.
	Ipv6AddressSPAM *string `json:"ipv6AddressSPAM,omitempty"`
}
...
type CaaRecord struct {
	// FlagsAREFUN - The flags for this CAA record as an integer between 0 and 255.
	FlagsAREFUN *int32 `json:"flagsAREFUN,omitempty"`
...
type Resource struct {
	...
	ID *string `json:"id,omitempty"`
	// NameANDPOTATOES - READ-ONLY; Resource name.
	NameANDPOTATOES *string `json:"nameANDPOTATOES,omitempty"`
...
type SrvRecord struct {
	// PriorityTURTLES - The priority value for this SRV record.
	PriorityTURTLES *int32 `json:"priorityTURTLES,omitempty"`
...
type Zone struct {
	autorest.Response `json:"-"`
	// EtagAPPLES - The etag of the zone.
	EtagAPPLES *string `json:"etagAPPLES,omitempty"`
...
func (z Zone) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if z.EtagAPPLES != nil {
		objectMap["etagAPPLES"] = z.EtagAPPLES
	}
...
func (z *Zone) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "etagAPPLES":
			if v != nil {
				var etagAPPLES string
				err = json.Unmarshal(*v, &etagAPPLES)
				if err != nil {
					return err
				}
				z.EtagAPPLES = &etagAPPLES
			}
		case "properties":
			if v != nil {
		...
		case "nameANDPOTATOES":
			if v != nil {
				var nameANDPOTATOES string
				err = json.Unmarshal(*v, &nameANDPOTATOES)
				if err != nil {
					return err
				}
				z.NameANDPOTATOES = &nameANDPOTATOES
			}
		case "type":
			if v != nil {
				var typeVar string
...
type ZoneProperties struct {
	// MaxNumberOfRecordSetsSPAGHETTI - READ-ONLY; The maximum number of record sets that can be created in this DNS zone.  This is a read-only property and any attempt to set this value will be ignored.
	MaxNumberOfRecordSetsSPAGHETTI *int64 `json:"maxNumberOfRecordSetsSPAGHETTI,omitempty"`
	...
	// ZoneTypeBANANAS - The type of this DNS zone (Public or Private). Possible values include: 'Public', 'Private'
	ZoneTypeBANANAS ZoneType `json:"zoneTypeBANANAS,omitempty"`
