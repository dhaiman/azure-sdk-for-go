...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/frontdoor/mgmt/2020-08-01/frontdoor"

// AssignmentPathLink defines the Resource ID for an Assignment Path.
type AssignmentPathLink struct {
	// ID - Resource ID.
...
type Properties struct {
	...
	// WebApplicationFirewallPolicyLinks - Defines the Web Application Firewall links (if applicable)
	WebApplicationFirewallPolicyLinks *[]UpdateParametersWebApplicationFirewallPolicyLinksItem `json:"webApplicationFirewallPolicyLinks,omitempty"`
}
...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	if p.WebApplicationFirewallPolicyLinks != nil {
		objectMap["webApplicationFirewallPolicyLinks"] = p.WebApplicationFirewallPolicyLinks
	}
	return json.Marshal(objectMap)
}
...
// UpdateParametersWebApplicationFirewallPolicyLinksItem defines the Web Application Firewall link
type UpdateParametersWebApplicationFirewallPolicyLinksItem struct {
	// ID - Resource ID.
	ID *string `json:"id,omitempty"`
	// Patterns - List of patterns to match.
	Patterns *[]UpdateParametersWebApplicationFirewallPolicyLinksItemPatternsItem `json:"patterns,omitempty"`
}

// UpdateParametersWebApplicationFirewallPolicyLinksItemPatternsItem patterns to match.
type UpdateParametersWebApplicationFirewallPolicyLinksItemPatternsItem struct {
...
type WebApplicationFirewallPolicyProperties struct {
	...
	// AssignmentPathLinks - READ-ONLY; Describes paths associated with this Web Application Firewall policy.
	AssignmentPathLinks *[]AssignmentPathLink `json:"assignmentPathLinks,omitempty"`
