...
// AgentPoolVersionProfile the agent pool's node image version.
type AgentPoolVersionProfile struct {
	// NodeImageVersion - The node image version.
...
type ManagedClusterAgentPoolProfile struct {
	...
	// AgentPoolVersionProfile - AgentPoolVersionProfile contains the agent pool components' version information.
	AgentPoolVersionProfile *AgentPoolVersionProfile `json:"agentPoolVersionProfile,omitempty"`
}
...
func (mcapp ManagedClusterAgentPoolProfile) MarshalJSON() ([]byte, error) {
	...
	if mcapp.AgentPoolVersionProfile != nil {
		objectMap["agentPoolVersionProfile"] = mcapp.AgentPoolVersionProfile
	}
	return json.Marshal(objectMap)
}
...
func (mcappp ManagedClusterAgentPoolProfileProperties) MarshalJSON() ([]byte, error) {
	...
	if mcappp.AgentPoolVersionProfile != nil {
		objectMap["agentPoolVersionProfile"] = mcappp.AgentPoolVersionProfile
	}
	return json.Marshal(objectMap)
}
