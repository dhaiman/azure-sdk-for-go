...
type DocumentSubmissionResponse struct {
	Job *OperationStatusSummary `json:"job,omitempty"`
...
// OperationStatusResponse document Status Response
type OperationStatusResponse struct {
	// Value - The summary status of individual opearation
	Value *[]OperationStatusSummary `json:"value,omitempty"`
	// NextLink - Url for the next page.  Null if no more pages available
	NextLink *string `json:"@nextLink,omitempty"`
}

// OperationStatusSummary job status response
