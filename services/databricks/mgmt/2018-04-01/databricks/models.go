...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/databricks/mgmt/2018-04-01/databricks"
        ...
        objectMap := make(map[string]interface{})
            ...
            // Identity - User assigned identity that will be used for Customer Managed Key Encryption while accessing Key Vault.
            Identity *string `json:"identity,omitempty"`
            // Type - The type of Identity created. It can be either SystemAssigned or UserAssigned. Possible values include: 'TypeSystemAssigned', 'TypeUserAssigned'
        ...
        objectMap := make(map[string]interface{})
                if(mic.Identity != nil) {
                objectMap["identity"] = mic.Identity
                }
                if(mic.Type != "") {
                objectMap["type"] = mic.Type
                }
                return json.Marshal(objectMap)
        }
