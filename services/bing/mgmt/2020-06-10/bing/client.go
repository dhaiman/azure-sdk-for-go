// Package bing implements the Azure ARM Bing service API version 2020-06-10.
//
...
// CheckSkuAvailability check whether specific SKUs are available for the location and
// Parameters:
// location - resource location.
// parameters - the SKUs to check for availability in the specified subscription and location.
