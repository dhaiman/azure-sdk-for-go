...
// ImageTemplateKeyvaultProperties specifies a key or version of a key in a Keyvault.
type ImageTemplateKeyvaultProperties struct {
	// KeyvaultURI - URI of Keyvault.
	KeyvaultURI *string `json:"keyvaultUri,omitempty"`
	// KeyName - Name of Keyvault key.
	KeyName *string `json:"keyName,omitempty"`
	// KeyVersion - Version of Keyvault key. Leave empty to always use the latest version of the key.
...
type ImageTemplateProperties struct {
	...
	// KeyvaultProperties - Customer Managed Key to be used for second level of encryption. Leave empty to disable second level of encryption.
	KeyvaultProperties *ImageTemplateKeyvaultProperties `json:"keyvaultProperties,omitempty"`
...
func (itp ImageTemplateProperties) MarshalJSON() ([]byte, error) {
	...
	if itp.KeyvaultProperties != nil {
		objectMap["keyvaultProperties"] = itp.KeyvaultProperties
	}
...
func (itp *ImageTemplateProperties) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "keyvaultProperties":
			if v != nil {
				var keyvaultProperties ImageTemplateKeyvaultProperties
				err = json.Unmarshal(*v, &keyvaultProperties)
				if err != nil {
					return err
				}
				itp.KeyvaultProperties = &keyvaultProperties
			}
