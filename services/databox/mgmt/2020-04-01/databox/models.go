...
const (
	// AzureBlob Filter file is of the type Azureblobs.
...
const (
	...
	// SkuDisabledReasonCustomerUnregistered Customer unregistered from the subscription.
	SkuDisabledReasonCustomerUnregistered SkuDisabledReason = "CustomerUnregistered"
...
func PossibleSkuDisabledReasonValues() []SkuDisabledReason {
	return []SkuDisabledReason{SkuDisabledReasonCountry, SkuDisabledReasonCustomerUnregistered, SkuDisabledReasonFeature, SkuDisabledReasonNone, SkuDisabledReasonNoSubscriptionInfo, SkuDisabledReasonOfferType, SkuDisabledReasonRegion}
}
...
type DiskScheduleAvailabilityRequest struct {
	// ExpectedDataSizeInTerabytes - The expected size of the data, which needs to be transferred in this job, in tera bytes.
	ExpectedDataSizeInTerabytes *int32 `json:"expectedDataSizeInTerabytes,omitempty"`
...
type Preferences struct {
	// PreferredDataCenterRegion - Preferrred data center region.
...
type RegionConfigurationResponse struct {
	autorest.Response `json:"-"`
	// ScheduleAvailabilityResponse - READ-ONLY; Schedule availability response
...
type SkuProperties struct {
	...
	// DisabledReason - READ-ONLY; Reason why the Sku is disabled. Possible values include: 'SkuDisabledReasonNone', 'SkuDisabledReasonCountry', 'SkuDisabledReasonRegion', 'SkuDisabledReasonFeature', 'SkuDisabledReasonOfferType', 'SkuDisabledReasonNoSubscriptionInfo', 'SkuDisabledReasonCustomerUnregistered'
