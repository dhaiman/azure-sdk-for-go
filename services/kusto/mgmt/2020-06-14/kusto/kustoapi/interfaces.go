...
type DataConnectionsClientAPI interface {
	...
	DataConnectionValidationAsync(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters kusto.DataConnectionValidation) (result kusto.DataConnectionsDataConnectionValidationAsyncFuture, err error)
