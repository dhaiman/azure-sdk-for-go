						...
						{Target: "cache.CacheProperties.DirectoryServicesSettings", Name: validation.Null, Rule: false,
							Chain: []validation.Constraint{{Target: "cache.CacheProperties.DirectoryServicesSettings.ActiveDirectory", Name: validation.Null, Rule: false,
								Chain: []validation.Constraint{{Target: "cache.CacheProperties.DirectoryServicesSettings.ActiveDirectory.PrimaryDNSIPAddress", Name: validation.Null, Rule: true, Chain: nil},
									...
									{Target: "cache.CacheProperties.DirectoryServicesSettings.ActiveDirectory.DomainNetBios", Name: validation.Null, Rule: true, Chain: nil},
									{Target: "cache.CacheProperties.DirectoryServicesSettings.ActiveDirectory.SmbServerName", Name: validation.Null, Rule: true,
										Chain: []validation.Constraint{{Target: "cache.CacheProperties.DirectoryServicesSettings.ActiveDirectory.SmbServerName", Name: validation.Pattern, Rule: `^[-0-9a-zA-Z]{1,15}$`, Chain: nil}}},
